...
//         url:"controller/creditos-ambulatorios-clientes-empresariales/controlador_credito_ambulatorio_asistencia_medica_individual_listar.php",
//         method: "POST",
//         cache: false,
//         contentType: false,
//         processData: false,
...
function listar_creditos_ambulatorios_asistencia_medica_individual() {
  table_listar_creditos_ambulatorios_asistencia_medica_individual = $(
    ...
    ajax: "controller/creditos-ambulatorios-clientes-empresariales/controlador_credito_ambulatorio_asistencia_medica_individual_listar.php",
...
function Registrar_Documento_Autorizacion_Credito_Ambulatorio() {
  ...
  if (
    ...
    return Swal.fire(
      "Mensaje De Advertencia",
      "Ingrese una observación para cargar la autorización del pedido credito ambulatorio",
      "warning"
    );
  }
