...
//         url:"controller/contratos-clientes/controlador_contrato_cliente_vehiculo_individual_listar.php",
//         method: "POST",
//         cache: false,
//         contentType: false,
//         processData: false,
...
function listar_cliente() {
  table = $("#tabla-contrato-cliente").DataTable({
    ...
    async: false,
    processing: true,
    ajax: "controller/contratos-clientes/controlador_contrato_cliente_vehiculo_individual_listar.php",
