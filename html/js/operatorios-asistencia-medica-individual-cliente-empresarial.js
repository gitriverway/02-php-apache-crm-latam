...
function listar_operatorios_cliente_asistencia_medica_individual() {
  table_listar_operatorios_asistencia_medica_individual = $(
    ...
    ajax: "controller/operatorios-clientes-empresariales/controlador_operatorio_cliente_asistencia_medica_individual_listar.php",
...
// $(".nuevoDatosOperatorio").on("keyup", "input.fecha_operacion", function () {
//   listarDatosOperatorio();
// });

// $(".nuevoDatosOperatorio").on("keyup", "input.lugar_hospitalario", function () {
//   listarDatosOperatorio();
// });

// $(".nuevoDatosOperatorio").on(
//   "keyup",
//   "textarea.diagnostico_operatorio",
//   function () {
//     listarDatosOperatorio();
//   }
// );
