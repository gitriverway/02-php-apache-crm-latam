...
//         url:"controller/reembolsos-clientes/controlador_reembolsos_cliente_asistencia_medica_individual_listar.php",
//         method: "POST",
//         cache: false,
//         contentType: false,
//         processData: false,
...
function listar_reembolsos_cliente_asistencia_medica_individual() {
  table_listar_reembolsos_asistencia_medica_individual = $(
    ...
    ajax: "controller/reembolsos-clientes/controlador_reembolsos_cliente_asistencia_medica_individual_listar.php",
...
$("#txt_documento_reembolso").change(function () {
  ...
  // Tamaño correcto en bytes (25 MB reales)
  var maxSizeMB = 25;
