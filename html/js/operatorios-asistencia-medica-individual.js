...
//         url:"controller/operatorios-clientes/controlador_operatorio_asistencia_medica_individual_listar.php",
//         method: "POST",
//         cache: false,
//         contentType: false,
//         processData: false,
...
function listar_operatorios_asistencia_medica_individual() {
  table_listar_operatorios_asistencia_medica_individual = $(
    ...
    ajax: "controller/operatorios-clientes/controlador_operatorio_asistencia_medica_individual_listar.php",
...
$("#txt_fecha_seguimiento1").change(function () {
  listarDocumentosAseguradora_1();
});
...
/*=============================================
    CAMBIOS EN OBSERVACIONES
    =============================================*/
$("#txt_observaciones_seguimiento_operatorio1").keyup(function () {
  listarDocumentosAseguradora_1();
});
...
function crear_overlay_seguimiento_operatorio_asistencia_medica_1() {
  $("#modalAgregarSeguimientoOperatorio1").append(
...
$("#tabla-listar-operatorios-asistencia-medica-individual").on(
  ...
  function () {
    ...
    $("#agregarDocumentoOperatorioPaciente1").text(paciente);
    $("#txt_idOperatorio").val(idOperatorio);
    $("#txt_idContrato").val(idContrato);
    ...
    Cargar_Observaciones_Documentos_Seguimientos1();
  }
);

/*=============================================
    CARGAR OBSERVACIONES DOCUMENTOS SEGUIMIENTOS PEDIDO OPERATORIO 1
  =============================================*/

function Cargar_Observaciones_Documentos_Seguimientos1() {
  var idOperatorio = $("#txt_idOperatorio").val();
...
/*=============================================
      LISTAR OBSERVACIONES DOCUMENTOS SEGUIMIENTOS PEDIDO OPERATORIO 1
    =============================================*/

function listarObservacionesDocumentosSeguimientoOperatorio1() {
  if (
...
function crear_overlay_documento_seguimiento_operatorio_asistencia_medica1() {
...
function eliminar_overlay_documento_seguimiento_operatorio_asistencia_medica1() {
...
/*****************************************************
   REGISTRAR UN NUEVO DOCUMENTO SEGUIMIENTO PEDIDO OPERATORIO
   ***************************************************/
function Registrar_Documento_Seguimiento_Operatorio1() {
  listarObservacionesDocumentosSeguimientoOperatorio1();
  ...
  crear_overlay_documento_seguimiento_operatorio_asistencia_medica1();
    ...
    success: function (respuesta) {
      ...
      if (data.length > 0) {
        Swal.fire(
          ...
          eliminar_overlay_documento_seguimiento_operatorio_asistencia_medica1();
