...
//         url:"controller/reembolsos-clientes-empresariales/controlador_reembolsos_asistencia_medica_individual_listar.php",
//         method: "POST",
//         cache: false,
//         contentType: false,
//         processData: false,
...
function listar_reembolsos_asistencia_medica_individual() {
  table_listar_reembolsos_asistencia_medica_individual = $(
    ...
    ajax: "controller/reembolsos-clientes-empresariales/controlador_reembolsos_asistencia_medica_individual_listar.php",
...
function reactivarReembolsoAnulado(idReembolso, estado) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url: "/controller/reembolsos-clientes-empresariales/controlador_reembolso_asistencia_medica_individual_reactivar.php",
        method: "POST",
        data: datos,
        cache: false,
        contentType: false,
...
function Modificar_Validar_Reembolso() {
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_reembolso_asistencia_medica_individual_validar_modificar.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function Cargar_Observaciones_Adicionales_Seguimientos_Reembolsos() {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      var data = JSON.parse(respuesta);
      if (data.length > 0) {
        var data1 = JSON.parse(data[0]["reembolso_descripcion"]);
        $("#span_nombre_paciente").text(data1[0]["nombre_paciente"]);
...
function Modificar_Observaciones_adicionales_Seguimiento_Reembolso() {
  ...
  $.ajax({
    url: "/controller/reembolsos-observaciones-empresariales/controlador_reembolso_asistencia_medica_individual_observaciones_adicionales_modificar.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function Cargar_lista_documentos_Solictados_Aseguradora_Seguimientos() {
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_documentos_adicionales_solictados_aseguradora_listar.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function Modificar_Seguimiento_Reembolso() {
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_reembolso_asistencia_medica_individual_seguimiento_modificar.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function Modificar_Seguimiento_Reembolso_1() {
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_reembolso_asistencia_medica_individual_seguimiento_modificar_1.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function Registrar_Documento_Seguimiento_Reembolso() {
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_reembolso_asistencia_medica_individual_documento_seguimiento_registro.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function Registrar_Documento_Seguimiento_Reembolso_1() {
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_reembolso_asistencia_medica_individual_documento_seguimiento_1_registro.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function cargar_deducible_dependiente_reembolso() {
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_traer_reembolso_asistencia_medica_individual.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
    ...
    success: function (respuesta) {
      ...
      if (data.length > 0) {
        for (let i = 0; i < data.length; i++) {
          ...
          var colaborador = lista_reembolso[0]["nombre_colaborador"];
          var paciente = lista_reembolso[0]["nombre_paciente"];
          $("#txt_colaborador_reembolso").val(colaborador);
          ...
          for (let j = 0; j < lista_dependiente.length; j++) {
            ...
            var dependientes = lista_dependiente[j]["lista_dependientes"];
            ...
            if (dependiente == paciente) {
              ...
              for (let k = 0; k < dependientes.length; k++) {
                var dependiente1 = dependientes[k][t("form_labels.name", "Nome")];
                if (dependiente1 == paciente) {
                  deducible = dependientes[k]["valor_deducible"];
                  $("#txt_deducible_contrato_dependiente").val(deducible);
                  $("#txt_saldo_deducible").val(deducible);
                }
              }
...
function actualizar_deducible_dependiente() {
  ...
  if (lista.length > 0) {
    ...
    for (let i = 0; i < lista.length; i++) {
      var listar_dependientes = lista[i]["lista_dependientes"];

      if (lista[i][t("form_labels.name", "Nome")] == $("#txt_colaborador_reembolso").val()) {
        saldo = lista[i]["valor_deducible"];

        if (lista[i][t("form_labels.name", "Nome")] == $("#txt_paciente_reembolso").val()) {
          saldo = $("#txt_saldo_deducible").val();
          lista_dependientes = lista[i]["lista_dependientes"];
        } else {
          if (listar_dependientes != "") {
            var saldo1 = 0;
            for (let j = 0; j < listar_dependientes.length; j++) {
              if (
                listar_dependientes[j][t("form_labels.name", "Nome")] ==
                $("#txt_paciente_reembolso").val()
              ) {
                saldo1 = $("#txt_saldo_deducible").val();
              } else {
                saldo1 = listaDependencia1[j]["valor_deducible"];
              }

              listaDependencia1.push({
                tipo: listar_dependientes[j]["tipo"],
                nombre: listar_dependientes[j][t("form_labels.name", "Nome")],
                genero: listar_dependientes[j]["genero"],
                fecha_nacimiento: listar_dependientes[j]["fecha_nacimiento"],
                edad: listar_dependientes[j]["edad"],
                valor_deducible: saldo1,
              });
            }
            lista_dependientes = listaDependencia1;
          }
        }
      } else {
        saldo = lista[i]["valor_deducible"];
      ...
      listaDependencia.push({
        ...
        lista_dependientes: lista_dependientes,
      });
    }
  }
...
function Registrar_Documento_Liquidacion_Reembolso() {
  ...
  var extension = archivo.split(".").pop();
  var documento = $("#txt_documento_reembolso_documento_liquidacion")[0]
    .files[0];
  ...
  $.ajax({
    url: "/controller/reembolsos-clientes-empresariales/controlador_reembolso_asistencia_medica_individual_documento_liquidacion_registro.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
...
function Modificar_Observaciones_Anulacion_Reembolso() {
  ...
  $.ajax({
    url: "/controller/reembolsos-observaciones-empresariales/controlador_reembolso_asistencia_medica_individual_observaciones_anulacion_modificar.php",
    method: "POST",
    data: datos,
    cache: false,
    contentType: false,
