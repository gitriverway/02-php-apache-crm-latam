...
class Modelo_Reembolso_Cliente  extends conexionBD
{
    ...
    function listar_reembolso_asistencia_medica($idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_REEMBOLSOS_ASISTENCIA_MEDICA(:categoria_id)';
    ...
    function listar_reembolso_cliente_asistencia_medica($idCliente, $idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_REEMBOLSOS_CLIENTES_ASISTENCIA_MEDICA(:cliente_id,:categoria_id)';
    ...
    function listar_reembolso_cliente_vida($idCliente, $idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_REEMBOLSOS_CLIENTES_VIDA(:cliente_id,:categoria_id)';
    ...
    function traer_reembolso_unico($idReembolso, $idContrato)
    {
        ...
        $sql = 'CALL SP_LISTAR_REEMBOLSOS_ASISTENCIA_MEDICA_IDREEMBOLSO(:idReembolso,:idContrato)';
    ...
    function Registrar_Reembolso($idBayer, $idContrato, $listaDatosReembolso, $fechaActual)
    {
        ...
        $sql = 'CALL SP_CREAR_REEMBOLSO_CLIENTE(:idBayer,:idContrato,:listaDatosReembolso,:fechaActual)';
    ...
    function Modificar_Reembolso_Validar($idReembolso, $listaValidarDatosReembolso, $listaObservacionesDatosReembolso, $fecha_seguimiento_validar, $contar_validar, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_REEMBOLSO_VALIDAR_CLIENTE(:idReembolso,:listaValidarDatosReembolso,:listaObservacionesDatosReembolso,:fecha_seguimiento_validar,:contar_validar,:fechaActual,:fechaActual1)';
    ...
    function listar_observacion_reembolsos($idReembolso)
    {
        ...
        $sql = 'CALL SP_LISTAR_OBSERVACIONES_REEMBOLSOS(:idReembolso)';
    ...
    function listar_documentos_solicitados_aseguradora_reembolsos($idReembolso)
    {
        ...
        $sql = 'CALL SP_LISTAR_DOCUMENTOS_SOLICITADOS_ASEGURADORA_REEMBOLSOS(:idReembolso)';
    ...
    function Modificar_Reembolso_Liquidacion($idReembolso, $idBayer, $idContrato, $lista_dependientes, $deducible_contrato, $valor_cobrado, $saldo_deducible, $valor_presentado, $valor_no_cubierto, $valor_copago, $valor_reembolsado, $fechaActual, $listaObservacionesLiquidacionReembolso, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_REEMBOLSO_LIQUIDACION_CLIENTE(:idReembolso,:idBayer,:idContrato,:lista_dependientes,:deducible_contrato,:valor_cobrado,:saldo_deducible,:valor_presentado,:valor_no_cubierto,:valor_reembolsado,:fechaActual,:valor_copago,:listaObservacionesLiquidacionReembolso,:fechaActual1)';
    ...
    function Modificar_Reembolso_Seguimiento($idReembolso, $listaDocumentosSolicitadosAseguradora, $listaObservacionesSeguimientosReembolso, $fecha_seguimiento, $fechaActual, $fechaActual1, $estado_caducado)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_REEMBOLSO_SEGUIMIENTO_CLIENTE(:idReembolso,:listaDocumentosSolicitadosAseguradora,:listaObservacionesSeguimientosReembolso,:fecha_seguimiento,:fechaActual,:fechaActual1,:estado_caducado)';
    ...
    function Modificar_Reembolso_Seguimiento_1($idReembolso, $listaDocumentosSolicitadosAseguradora, $listaObservacionesSeguimientosReembolso, $fecha_seguimiento, $fechaActual, $fechaActual1, $estado_caducado)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_REEMBOLSO_SEGUIMIENTO_CLIENTE_1(:idReembolso,:listaDocumentosSolicitadosAseguradora,:listaObservacionesSeguimientosReembolso,:fecha_seguimiento,:fechaActual,:fechaActual1,:estado_caducado)';
    ...
    function Modificar_Envio_Reembolso_Seguimiento($idReembolso, $fecha_seguimiento, $listaObservacionesDocumentoSeguimientosReembolso, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_REEMBOLSO_SEGUIMIENTO_ASEGURADORA(:idReembolso,:fecha_seguimiento,:listaObservacionesDocumentoSeguimientosReembolso,:fechaActual,:fechaActual1)';
