<?php
    ...
    class Modelo_Reembolso_Observacion_Empresarial  extends conexionBD{
    ...
    ***********************************/
    function Modificar_Observaciones_Adicionales_Seguimiento_Reembolso($idReembolso,$lista_observaciones_adicionales,$fecha_seguimiento,$fechaActual,$fechaActual1){
        ...
        $sql = 'CALL SP_MODIFICAR_REEMBOLSO_OBSERVACION_PYMES(:idReembolso,:lista_observaciones_adicionales,:fecha_seguimiento,:fechaActual,:fechaActual1)';
        ...
        /***********************************
     *******MODIFICAR OBSERVACION ANULACION REEMBOLSO CLIENTE
    ***********************************/
    function Modificar_Observaciones_Anulacion_Reembolso($idReembolso,$lista_observaciones_anulacion,$fechaActual,$fechaActual1){

        $c = conexionBD::conexionPDO();

        $sql = 'CALL SP_MODIFICAR_REEMBOLSO_ANULACION_OBSERVACION_PYMES(:idReembolso,:lista_observaciones_anulacion,:fechaActual,:fechaActual1)';
