...
class Modelo_Credito_Ambulatorio_Cliente extends conexionBD
{
    ...
    /***********************************
     *******CONSULTAR LISTA DE CREDITO AMBULATORIO
     ***********************************/
    ...
    function listar_credito_ambulatorio_asistencia_medica($idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_CREDITOS_AMBULATORIOS_ASISTENCIA_MEDICA(:categoria_id)';
    ...
    function listar_credito_ambulatorio_cliente_asistencia_medica($idCliente, $idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_CREDITOS_AMBULATORIOS_CLIENTES_ASISTENCIA_MEDICA(:cliente_id,:categoria_id)';
    ...
    function traer_credito_ambulatorio_unico($idCreditoAmbulatorio, $idContrato)
    {
        ...
        $sql = 'CALL SP_LISTAR_CREDITOS_AMBULATORIOS_ASISTENCIA_MEDICA_IDAMBULATORIO(:idCreditoAmbulatorio,:idContrato)';
    ...
    function Registrar_Credito_Ambulatorio($idBayer, $idContrato, $listaDatosOperatorio, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_CREAR_CREDITO_AMBULATORIO_CLIENTE(:idBayer,:idContrato,:listaDatosOperatorio,:fechaActual,:fechaActual1)';
    ...
    function Modificar_Credito_Ambulatorio_Validar($idCreditoAmbulatorio, $listaValidarDatosOperatorio, $listaObservacionesDatosOperatorio, $fecha_seguimiento_validar, $contar_validar, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_CREDITO_AMBULATORIO_VALIDAR_CLIENTE(:idCreditoAmbulatorio,:listaValidarDatosOperatorio,:listaObservacionesDatosOperatorio,:fecha_seguimiento_validar,:contar_validar,:fechaActual,:fechaActual1)';
    ...
    function listar_observacion_creditos_ambulatorios($idCreditoAmbulatorio)
    {
        ...
        $sql = 'CALL SP_LISTAR_OBSERVACIONES_CREDITOS_AMBULATORIOS(:idCreditoAmbulatorio)';
    ...
    function listar_documentos_solicitados_aseguradora_creditos_ambulatorios($idCreditoAmbulatorio)
    {
        ...
        $sql = 'CALL SP_LISTAR_DOCUMENTOS_SOLICITADOS_ASEGURADORA_CREDITO_AMBULATORIO(:idCreditoAmbulatorio)';
    ...
    /***********************************
     *******MODIFICAR AUTORIZACION CREDITO HOSPITALARIO CLIENTE
     ***********************************/
    function Modificar_Credito_Ambulatorio_Autorizacion($idCreditoAmbulatorio, $listaObservacionesAutorizacionOperatorio, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_CREDITO_AMBULATORIO_AUTORIZACION_CLIENTE(:idCreditoAmbulatorio,:listaObservacionesAutorizacionOperatorio,:fechaActual,:fechaActual1)';
    ...
    /***********************************
     *******MODIFICAR SEGUIMIENTO CREDITO AMBULATORIO CLIENTE
     ***********************************/
    ...
    {
        $sql = 'CALL SP_MODIFICAR_CREDITO_AMBULATORIO_SEGUIMIENTO_CLIENTE(:idCreditoAmbulatorio,:listaDocumentosSolicitadosAseguradora,:listaObservacionesSeguimientosOperatorio,:fecha_seguimiento,:fechaActual,:fechaActual1,:estado_caducado)';
    ...
    {
        $sql = 'CALL SP_MODIFICAR_CREDITO_AMBULATORIO_SEGUIMIENTO_CLIENTE_1(:idCreditoAmbulatorio,:listaDocumentosSolicitadosAseguradora,:listaObservacionesSeguimientosOperatorio,:fecha_seguimiento,:fechaActual,:fechaActual1,:estado_caducado)';
    ...
    /***********************************
     *******MODIFICAR SEGUIMIENTO PEDIDO CREDITO AMBULATORIO CLIENTE
     ***********************************/
    function Modificar_Envio_Credito_Ambulatorio_Seguimiento($idCreditoAmbulatorio, $fecha_seguimiento, $listaObservacionesDocumentoSeguimientosOperatorio, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_CREDITO_AMBULATORIO_SEGUIMIENTO_ASEGURADORA(:idCreditoAmbulatorio,:fecha_seguimiento,:listaObservacionesDocumentoSeguimientosOperatorio,:fechaActual,:fechaActual1)';
