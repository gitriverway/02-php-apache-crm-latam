<?php
    ...
    class Modelo_Contrato_Cliente_Documento_Empresarial  extends conexionBD{
        ...
        ***********************************/
        ...
        function listar_contrato_cliente_documento($idCliente){
            ...
            $sql = 'CALL SP_LISTAR_CONTRATOS_CLIENTES_DOCUMENTO_PYMES(:idCliente)';
        ...
        ***********************************/
        function Registrar_contrato_cliente_documento($idBayer,$nombreArchivo,$carpetaDocumento,$rutaArchivo,$fechaActual){
            ...
            $sql = 'CALL SP_CREAR_CONTRATO_CLIENTE_DOCUMENTO_PYMES(:cliente_id,:nombre_documento,:carpeta_documento,:ruta_documento,:fechaActual)';
    ...
    ***********************************/
    function Eliminar_Documento_Emision($idDocumentoEmision){
        ...
        $sql = 'CALL SP_ELIMINAR_DOCUMENTO_EMISION_PYMES(:idDocumentoEmision)';
