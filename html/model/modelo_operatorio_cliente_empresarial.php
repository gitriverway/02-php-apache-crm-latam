...
class Modelo_Operatorio_Cliente_Empresarial extends conexionBD
{
    ...
    function listar_operatorio_asistencia_medica($idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_OPERATORIOS_ASISTENCIA_MEDICA_PYMES(:categoria_id)';
    ...
    function listar_operatorio_cliente_asistencia_medica($idCliente, $idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_OPERATORIOS_CLIENTES_ASISTENCIA_MEDICA_PYMES(:cliente_id,:categoria_id)';
    ...
    function traer_operatorio_unico($idOperatorio, $idContrato)
    {
        ...
        $sql = 'CALL SP_LISTAR_OPERATORIOS_ASISTENCIA_MEDICA_IDOPERATORIO_PYMES(:idOperatorio,:idContrato)';
    ...
    function Registrar_Operatorio($idBayer, $idContrato, $listaDatosOperatorio, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_CREAR_OPERATORIO_CLIENTE_PYMES(:idBayer,:idContrato,:listaDatosOperatorio,:fechaActual,:fechaActual1)';
    ...
    function Modificar_Operatorio_Validar($idOperatorio, $listaValidarDatosOperatorio, $listaObservacionesDatosOperatorio, $fecha_seguimiento_validar, $contar_validar, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_OPERATORIO_VALIDAR_CLIENTE_PYMES(:idOperatorio,:listaValidarDatosOperatorio,:listaObservacionesDatosOperatorio,:fecha_seguimiento_validar,:contar_validar,:fechaActual,:fechaActual1)';
    ...
    function listar_observacion_operatorios($idOperatorio)
    {
        ...
        $sql = 'CALL SP_LISTAR_OBSERVACIONES_OPERATORIOS_PYMES(:idOperatorio)';
    ...
    function listar_documentos_solicitados_aseguradora_operatorios($idOperatorio)
    {
        ...
        $sql = 'CALL SP_LISTAR_DOCUMENTOS_SOLICITADOS_ASEGURADORA_OPERATORIOS_PYMES(:idOperatorio)';
    ...
    function Modificar_Operatorio_Autorizacion($idOperatorio, $listaObservacionesAutorizacionOperatorio, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_OPERATORIO_AUTORIZACION_CLIENTE_PYMES(:idOperatorio,:listaObservacionesAutorizacionOperatorio,:fechaActual,fechaActual1)';
    ...
    function Modificar_Operatorio_Seguimiento($idOperatorio, $listaDocumentosSolicitadosAseguradora, $listaObservacionesSeguimientosOperatorio, $fecha_seguimiento, $fechaActual, $fechaActual1, $estado_caducado)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_OPERATORIO_SEGUIMIENTO_CLIENTE_PYMES(:idOperatorio,:listaDocumentosSolicitadosAseguradora,:listaObservacionesSeguimientosOperatorio,:fecha_seguimiento,:fechaActual,:fechaActual1,:estado_caducado)';
    ...
    function Modificar_Operatorio_Seguimiento_1($idOperatorio, $listaDocumentosSolicitadosAseguradora, $listaObservacionesSeguimientosOperatorio, $fecha_seguimiento, $fechaActual, $fechaActual1, $estado_caducado)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_OPERATORIO_SEGUIMIENTO_CLIENTE_PYMES_1(:idOperatorio,:listaDocumentosSolicitadosAseguradora,:listaObservacionesSeguimientosOperatorio,:fecha_seguimiento,:fechaActual,:fechaActual1,:estado_caducado)';
    ...
    function Modificar_Envio_Operatorio_Seguimiento($idOperatorio, $fecha_seguimiento, $listaObservacionesDocumentoSeguimientosOperatorio, $fechaActual, $fechaActual1)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_OPERATORIO_SEGUIMIENTO_ASEGURADORA_PYMES(:idOperatorio,:fecha_seguimiento,:listaObservacionesDocumentoSeguimientosOperatorio,:fechaActual,:fechaActual1)';
