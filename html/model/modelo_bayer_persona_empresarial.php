...
class Modelo_Bayer_Persona_Empresarial extends conexionBD
{
    ...
    function listar_cliente_vida_individual($idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_BAYER_PERSONAS_EMPRESARIALES(:id_categoria)';
    ...
    function listar_cliente_responsabilidad_civil_empresarial($idCategoria)
    {
    ...
    function listar_cliente_vida_individual_asignados($idUsuario, $idCategoria)
    {
        ...
        $sql = 'CALL SP_LISTAR_BAYER_PERSONAS_EMPRESARIALES_ASIGNADOS(:id_usuario,:id_categoria)';
    ...
    function listar_cliente_responsabilidad_civil_empresarial_asignados($idUsuario, $idCategoria)
    {
    ...
    function Modificar_Vendedor_Asigando_Cliente($idCliente, $idEmpleado)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_VENDEDOR_ASIGANDO_CLIENTE_PYMES(:id_cliente,:id_empleado)';
    ...
    function Modificar_Estado_Bayer_Cliente($idCliente, $estadoBayer)
    {
        ...
        $sql = 'CALL SP_MODIFICAR_ESTADO_BAYER_CLIENTE_PYMES(:id_cliente,:estado_bayer)';
    ...
    function TraerDatosBayer($idProspecto, $tipo)
    {
        ...
        $sql = 'CALL SP_UNICO_BAYER_PERSONA_PYMES(:id_prospecto,:tipo)';
    ...
    function TraerDatosBayerContrato($idProspecto)
    {
        ...
        $sql = 'CALL SP_UNICO_BAYER_CONTRATO_PYMES(:id_prospecto)';
    ...
    function listar_observacion_cliente($idCliente)
    {
        ...
        $sql = 'CALL SP_LISTAR_OBSERVACIONES_CLIENTES_PYMES(:id_cliente)';
    ...
    function listar_observacion_prospecto($idProspecto)
    {
        ...
        $sql = 'CALL SP_LISTAR_OBSERVACIONES_PROSPECTOS_PYMES(:id_prospecto)';
    ...
    function listar_prospecto()
    {
        ...
        $sql = 'CALL SP_LISTAR_PROSPECTOS_PYMES()';
    ...
    function listar_prospecto_asignado($idUsuario)
    {
        ...
        $sql = 'CALL SP_LISTAR_PROSPECTOS_ASIGNADOS_PYMES(:id_usuario)';
    ...
    function Registrar_Prospecto($origen, $categoria, $idCliente, $cedula, $nombre_prospecto, $telefono, $email, $provincia, $ciudad, $direccion, $ocupacion, $valor_ingreso, $valor_asegurado, $prima_total, $tipo_pago, $forma_pago, $listaObservaciones, $idUsuario, $estado_bayer, $idProducto, $fechaActual, $proveedor, $contra, $fecha_seguimiento, $prima_comisionable, $prima_neta, $nueva_categoria, $listaColaboradores, $listaVehiculos)
    {
        ...
        $sql = 'CALL SP_CREAR_PROSPECTO_PYMES(:origen,:categoria,:cedula,:nombre_prospecto,:telefono,:email,:provincia,:ciudad,:direccion,:ocupacion,:valor_ingreso,:valor_asegurado,:prima_total,:tipo_pago,:forma_pago,:lista_observacion,:idUsuario,:estado_bayer,:idProducto,:fecha_actual,:proveedor,:contra,:fecha_seguimiento,:idCliente,:prima_comisionable,:prima_neta,:nueva_categoria,:lista_colaboradores,:lista_vehiculo)';
        ...
        $stmt->bindParam(':lista_colaboradores', $listaColaboradores, PDO::PARAM_STR);
     ...
     *******MODIFICAR PROSPECTO
     ***********************************/
    function Modificar_Prospecto($idBayer, $origen, $categoria, $cedula, $nombre_prospecto, $telefono, $email, $provincia, $ciudad, $direccion, $ocupacion, $valor_ingreso, $valor_asegurado, $prima_total, $tipo_pago, $forma_pago, $listaObservaciones, $idUsuario, $estado_bayer, $idProducto, $fechaActual, $proveedor, $contra, $fecha_seguimiento, $idCliente, $prima_comisionable, $prima_neta, $nueva_categoria, $idDependiente, $listaColaboradores, $listaVehiculos, $idEmpleado)

    {

        $c = conexionBD::conexionPDO();

        $sql = 'CALL SP_MODIFICAR_PROSPECTO_PYMES(:idBayer,:origen,:categoria,:cedula,:nombre_prospecto,:telefono,:email,:provincia,:ciudad,:direccion,:ocupacion,:valor_ingreso,:valor_asegurado,:prima_total,:tipo_pago,:forma_pago,:lista_observacion,:idUsuario,:estado_bayer,:idProducto,:fecha_actual,:proveedor,:contra,:fecha_seguimiento,:idCliente,:prima_comisionable,:prima_neta,:nueva_categoria,:idDependiente,:lista_colaboradores,:lista_vehiculo,:idEmpleado)';
    ...
    function listar_dependientes_asistencia_medica($idBayer, $idContrato)
    {
        ...
        $sql = 'CALL SP_LISTAR_DEPENDIENTES_ASISTENCIA_MEDICA_PYMES(:idBayer,:idContrato)';
    ...
    function listar_cliente_incendio_empresarial_asignados($idUsuario, $idCategoria)
    {
    ...
    function listar_cliente_incendio_empresarial($idCategoria)
    {
    ...
    function listar_cliente_transporte_empresarial_asignados($idUsuario, $idCategoria)
    {
    ...
    function listar_cliente_transporte_empresarial($idCategoria)
    {
    ...
    function listar_dependientes_transporte_empresarial($idBayer, $idContrato)
    {

        $c = conexionBD::conexionPDO();

        $sql = 'CALL SP_LISTAR_DEPENDIENTES_TRANSPORTE_PYMES(:idBayer,:idContrato)';
