<?php
    ...
    class Modelo_Operatorio_Observacion  extends conexionBD{
    ...
    ***********************************/
    function Modificar_Observaciones_Adicionales_Seguimiento_Operatorio($idOperatorio,$lista_observaciones_adicionales,$fecha_seguimiento,$fechaActual,$fechaActual1){
        ...
        $sql = 'CALL SP_MODIFICAR_OPERATORIO_OBSERVACION(:idOperatorio,:lista_observaciones_adicionales,:fecha_seguimiento,:fechaActual,:fechaActual1)';
    ...
    ***********************************/
    function Modificar_Observaciones_Anulacion_Seguimiento_Operatorio($idOperatorio,$lista_observaciones_adicionales,$fechaActual,$fechaActual1){
        ...
        $sql = 'CALL SP_MODIFICAR_OPERATORIO_ANULACION_OBSERVACION(:idOperatorio,:lista_observaciones_adicionales,:fechaActual,:fechaActual1)';
