...
class Modelo_Contrato_Cliente_Empresarial  extends conexionBD
{
    ...
    function listar_contrato_cliente($idCliente, $idCategoria, $estado)
    {
        ...
        $sql = 'CALL SP_LISTAR_CONTRATOS_CLIENTES_PYMES(:cliente_id,:categoria_id,:estado)';
    ...
    {
        $sql = 'CALL SP_LISTAR_CONTRATOS_CLIENTES_SELECCIONADO_PYMES(:cliente_id,:categoria_id,:fecha)';
    ...
    {
        $sql = 'CALL SP_LISTAR_CONTRATOS_CLIENTES_TODOS_PYMES(:categoria_id,:fecha)';
