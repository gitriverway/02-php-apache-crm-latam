<?php
    ...
    class Modelo_Reembolso_Cliente_Documento_Empresarial  extends conexionBD{
        ...
        ***********************************/
        ...
        function listar_reembolso_cliente_documento($idCliente){
            ...
            $sql = 'CALL SP_LISTAR_REEMBOLSOS_CLIENTES_DOCUMENTO_PYMES(:idCliente)';
        ...
        ***********************************/
        function Registrar_reembolso_cliente_documento($idReembolso,$nombreArchivo,$rutaArchivo,$fechaActual){
            ...
            $sql = 'CALL SP_CREAR_REEMBOLSO_CLIENTE_DOCUMENTO_PYMES(:idReembolso,:nombre_documento,:ruta_documento,:fechaActual)';
