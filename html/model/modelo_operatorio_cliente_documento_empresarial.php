<?php
    ...
    class Modelo_Operatorio_Cliente_Documento_Empresarial  extends conexionBD{
        ...
        ***********************************/
        function Registrar_operatorio_cliente_documento($idOperatorio,$nombreArchivo,$rutaArchivo,$fechaActual){
            ...
            $sql = 'CALL SP_CREAR_OPERATORIO_CLIENTE_DOCUMENTO_PYMES(:idOperatorio,:nombre_documento,:ruta_documento,:fechaActual)';
