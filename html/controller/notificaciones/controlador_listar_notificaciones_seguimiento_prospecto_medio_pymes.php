...
class ControladorListaNotificacionesSeguimientoProspecto
{
        ...
        static public function traer_lista_notificaciones_seguimiento_prospecto()
        {
                ...
                if (!$consulta) {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-sm-inline-block'>" . Modelo_Idioma::t('prospects') . " Pymes Medio&nbsp;</strong></i>                
                                </a>
                                ...
                                <span class='dropdown-item dropdown-header'>" . Modelo_Idioma::t('list_prospect') . " PYMES MEDIO</span>
                                        <div class='dropdown-divider'></div>
                                        " . $lista1 . "
                                        <div class='dropdown-divider'></div>
                                        <a href='prospecto-asignado-empresarial' class='dropdown-item dropdown-footer'>" . Modelo_Idioma::t('view_all_notifications') . "</a>
                                </div>
                                ";
