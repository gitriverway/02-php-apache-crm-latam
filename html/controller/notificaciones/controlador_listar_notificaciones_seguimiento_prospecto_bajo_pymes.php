...
class ControladorListaNotificacionesSeguimientoProspecto
{
        ...
        static public function traer_lista_notificaciones_seguimiento_prospecto()
        {
                ...
                if (!$consulta) {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-sm-inline-block'><?php echo $t('prospects'); ?> Pymes Bajo&nbsp;</strong></i>                
                                </a>
                                ...
                                <span class='dropdown-item dropdown-header'><?php echo $t('list_prospect'); ?> PYMES BAJO</span>
                                        <div class='dropdown-divider'></div>
                                        " . $lista1 . "
                                        <div class='dropdown-divider'></div>
