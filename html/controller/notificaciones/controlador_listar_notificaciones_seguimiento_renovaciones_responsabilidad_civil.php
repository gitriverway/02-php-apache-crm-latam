...
class ControladorListaNotificacionesSeguimientoRenovacionesResponsabilidadCivil
{
        ...
        static public function traer_lista_notificaciones_seguimiento_renovaciones_responsabilidad_civil()
        {
                ...
                if (!$consulta) {
                        ...
                        //         <i class='far fa-comments'><strong class='d-none d-sm-inline-block'><?php echo $t('renewal'); ?> </br> <?php echo $t('medical_assistance'); ?></strong></i>                
                        //                 </a>
                        ...
                        <i class='far fa-comments'><strong class='d-none d-sm-inline-block'><?php echo $t('renewal'); ?> </br> <?php echo $t('liability'); ?></strong></i>                
                                </a>
