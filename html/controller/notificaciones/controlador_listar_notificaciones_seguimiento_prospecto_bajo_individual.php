...
class ControladorListaNotificacionesSeguimientoProspecto
{
        ...
        static public function traer_lista_notificaciones_seguimiento_prospecto()
        {
                ...
                if (!$consulta) {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-sm-inline-block'>" . Modelo_Idioma::t('prospects') . " Individual Bajo&nbsp;</strong></i>                
                                </a>
                                ...
                                <span class='dropdown-item dropdown-header'>" . Modelo_Idioma::t('list_prospect') . " BAJO SEGUIMIENTO</span>
