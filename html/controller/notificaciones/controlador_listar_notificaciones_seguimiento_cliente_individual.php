...
class ControladorListaNotificacionesSeguimientoClienteIndividual
{
        ...
        static public function traer_lista_notificaciones_seguimiento_cliente_inidividual()
        {
                ...
                if (!$consulta) {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-md-inline-block'>Clientes Individual&nbsp;</strong></i>                
                                </a>
                                ...
                                <span class='dropdown-item dropdown-header'>LISTA CLIENTES INDIVIDUAL</span>
