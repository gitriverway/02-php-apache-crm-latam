...
class ControladorListaNotificacionesSeguimientoRenovacionesAsistenciaMedica
{
        ...
        static public function traer_lista_notificaciones_seguimiento_renovaciones_asistencia_medica()
        {
                ...
                if (!$consulta) {
                        ...
                        <i class='far fa-comments'><strong class='d-none d-sm-inline-block'>" . Modelo_Idioma::t('renewal') . " </br> " . Modelo_Idioma::t('medical_assistance') . " Pymes</strong></i>                
                                </a>
                                ...
                                <span class='dropdown-item dropdown-header'>LISTA RENOVACIONES - ASISTENCIA MEDICA PYMES</span>
