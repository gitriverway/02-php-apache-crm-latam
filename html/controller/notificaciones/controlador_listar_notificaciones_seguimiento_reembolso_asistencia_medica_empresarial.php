...
class ControladorListaNotificacionesSeguimientoCliente
{
        ...
        static public function traer_lista_notificaciones_seguimiento_cliente()
        {
                ...
                if (!$consulta) {
                        ...
                        //         <i class='far fa-bell'><strong class='d-none d-sm-inline-block'>Reembolsos </br> Asistencia Medica Pymes</strong></i>        
                        //         </a>
                        ...
                        for ($i = 0; $i < count($consulta); $i++) {
                                ...
                                if ($_SESSION['S_ROL'] == "ADMINISTRADOR" || $_SESSION['S_ROL'] == "GERENTE") {
                                        ...
                                        $lista2 = "<a href='reembolsos-asistencia-medica-individual-empresarial' class='dropdown-item dropdown-footer'>Ver todas las notificaciones</a>";
                                        ...
                                        $lista2 = "<a href='reembolsos-asistencia-medica-individual-cliente-empresarial' class='dropdown-item dropdown-footer'>Ver todas las notificaciones</a>";
                                } else {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-sm-inline-block'>Reembolsos </br> Asistencia Medica Pymes</strong></i>                
                                ...
                                <span class='dropdown-item dropdown-header'>LISTA REEMBOLSO PYMES</span>
                                        <div class='dropdown-divider'></div>
                                        " . $lista1 . "
                                        <div class='dropdown-divider'></div>
                                        " . $lista2 . "
