...
class ControladorListaNotificacionesSeguimientoCliente
{
        ...
        static public function traer_lista_notificaciones_seguimiento_cliente()
        {
                ...
                if (!$consulta) {
                        ...
                        //         <i class='far fa-bell'><strong class='d-none d-sm-inline-block'><?php echo $t('refunds'); ?> </br> <?php echo $t('medical_assistance'); ?> Pymes</strong></i>        
                        //         </a>
                        ...
                        for ($i = 0; $i < count($consulta); $i++) {
                                ...
                                if ($_SESSION['S_ROL'] == "ADMINISTRADOR" || $_SESSION['S_ROL'] == "GERENTE") {
                                        ...
                                        $lista2 = "<a href='reembolsos-asistencia-medica-individual-empresarial' class='dropdown-item dropdown-footer'><?php echo $t('view_all_notifications'); ?></a>";
                                        ...
                                        $lista2 = "<a href='reembolsos-asistencia-medica-individual-cliente-empresarial' class='dropdown-item dropdown-footer'><?php echo $t('view_all_notifications'); ?></a>";
                                } else {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-sm-inline-block'><?php echo $t('refunds'); ?> </br> <?php echo $t('medical_assistance'); ?> Pymes</strong></i>                
                                ...
                                <span class='dropdown-item dropdown-header'><?php echo $t('list_refund'); ?> PYMES</span>
                                        <div class='dropdown-divider'></div>
                                        " . $lista1 . "
                                        <div class='dropdown-divider'></div>
                                        " . $lista2 . "
