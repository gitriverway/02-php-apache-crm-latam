        ...
        static public function traer_lista_notificaciones_seguimiento_cliente()
        {
                ...
                if (!$consulta) {
                        ...
                        for ($i = 0; $i < count($consulta); $i++) {
                                ...
                                if ($_SESSION['S_ROL'] == "ADMINISTRADOR" || $_SESSION['S_ROL'] == "GERENTE") {
                                        $lista1 .= "<a href='reembolsos-asistencia-medica-individual-empresarial' class='dropdown-item' idCategoria = '" . $consulta[$i]["categoria_id"] . "'><i class='fas fa-envelope mr-2'></i> " . $contar . " Reembolso seguimiento</br><i class='fas fa-user mr-2'></i> " . $consulta[$i]["cliente_nombre"] . " </br><i class='fas fa-calendar mr-2'></i> " . $consulta[$i]["reembolso_fecha_seguimiento"] . "</a>";
                                        $lista2 = "<a href='reembolsos-asistencia-medica-individual-empresarial' class='dropdown-item dropdown-footer'>" . Modelo_Idioma::t('view_all_notifications') . "</a>";
                                } elseif ($_SESSION['S_ROL'] == "CLIENTE") {
                                        $lista1 .= "<a href='reembolsos-asistencia-medica-individual-cliente-empresarial' class='dropdown-item' idCategoria = '" . $consulta[$i]["categoria_id"] . "'><i class='fas fa-envelope mr-2'></i> " . $contar . " Reembolso seguimiento</br><i class='fas fa-user mr-2'></i> " . $consulta[$i]["cliente_nombre"] . " </br><i class='fas fa-calendar mr-2'></i> " . $consulta[$i]["reembolso_fecha_seguimiento"] . "</a>";
                                        $lista2 = "<a href='reembolsos-asistencia-medica-individual-cliente-empresarial' class='dropdown-item dropdown-footer'>" . Modelo_Idioma::t('view_all_notifications') . "</a>";
                                } else {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-sm-inline-block'>" . Modelo_Idioma::t('refunds') . " </br> " . Modelo_Idioma::t('medical_assistance') . " Pymes</strong></i>                
                                </a>
                                ...
                                <span class='dropdown-item dropdown-header'>" . Modelo_Idioma::t('list_refund') . " PYMES</span>
