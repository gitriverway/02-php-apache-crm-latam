...
class ControladorListaNotificacionesSeguimientoClientePymes
{
        ...
        static public function traer_lista_notificaciones_seguimiento_cliente_pymes()
        {
                ...
                if (!$consulta) {
                        ...
                        <i class='far fa-bell'><strong class='d-none d-md-inline-block'><?php echo $t('clients'); ?> Pymes&nbsp;</strong></i>                
                                </a>
                                ...
                                <span class='dropdown-item dropdown-header'><?php echo $t('list_clients'); ?> PYMES</span>
                                        <div class='dropdown-divider'></div>
                                        " . $lista1 . "
                                        <div class='dropdown-divider'></div>
                                </div>
