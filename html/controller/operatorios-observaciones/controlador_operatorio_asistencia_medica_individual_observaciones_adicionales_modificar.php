...
require '../../model/modelo_operatorio_observacion.php';
...
$MU = new Modelo_Operatorio_Observacion();
...
$MO = new Envio_correo_observaciones_operatorio();
$consulta1 = $MO->realizar_envio_correo_observaciones_operatorio($idOperatorio, $idContrato);
