...
require 'controlador_credito_ambulatorio_enviar_correo_autorizacion_cliente.php';
...
/*=============================================
    CREAMOS EL DIRECTORIO DONDE VAMOS A GUARDAR LOS ARCHIVOS DEL CREDITO AMBULATORIO
    =============================================*/
...
$ECL = new Envio_correo_notificacion_autorizacion_credito_ambulatorio();
$consulta2 = $ECL->realizar_envio_correo_notificacion_autorizacion_credito_ambulatorio($idCreditoAmbulatorio, $idContrato);
