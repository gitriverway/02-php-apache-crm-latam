...
class Envio_correo_documentos_seguimiento_credito_ambulatorio
{

    function realizar_envio_correo_documentos_seguimiento_credito_ambulatorio($idCreditoAmbulatorio, $idContrato)
    {
