...
class Envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio
{

    function realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio($idCreditoAmbulatorio, $idContrato)
    {
