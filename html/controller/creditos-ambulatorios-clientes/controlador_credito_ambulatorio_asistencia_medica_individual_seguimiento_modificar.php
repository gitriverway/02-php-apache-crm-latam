...
require 'controlador_credito_ambulatorio_enviar_correo_notificacion_documentos_faltantes_seguimiento_cliente.php';
...
if ($estado_caducado == "SI") {
    ...
    if ($enviar_mail == "SI") {
        $MC = new Envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio();
        $consulta1 = $MC->realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio($idCreditoAmbulatorio, $idContrato);
    }
}
