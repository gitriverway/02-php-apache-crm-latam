...
require 'controlador_credito_ambulatorio_enviar_correo_notificacion_documentos_faltantes_seguimiento_cliente1.php';
...
$consulta = $MU->Modificar_Credito_Ambulatorio_Seguimiento_1($idCreditoAmbulatorio, $listaDocumentosSolicitadosAseguradora, $listaObservacionesSeguimientosCreditoAmbulatorio, $fecha_seguimiento, $fechaActual, $fechaActual1, $estado_caducado);
...
if (isset($_FILES["documento"])) {
    ...
    $MOCD = new Modelo_Credito_Ambulatorio_Cliente_Documento();
...
if ($estado_caducado == "SI") {
    ...
    if ($enviar_mail == "SI") {
        $MC = new Envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio1();
        $consulta1 = $MC->realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio1($idCreditoAmbulatorio, $idContrato);
    }
}
