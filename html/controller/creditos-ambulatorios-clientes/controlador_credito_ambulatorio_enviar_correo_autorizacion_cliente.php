...
class Envio_correo_notificacion_autorizacion_credito_ambulatorio
{

    function realizar_envio_correo_notificacion_autorizacion_credito_ambulatorio($idCreditoAmbulatorio, $idContrato)
    {
        global $t;
        ...
        try {
            ...
            $mail->Subject = $t('email_credito_ambulatorio_autorizacion_cliente.subject', ['ticket' => $Ticket]);
            ...
            <div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
                ...
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('email_credito_ambulatorio_autorizacion_cliente.dear_client') . ': ' . $nombre . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('email_credito_ambulatorio_autorizacion_cliente.authorization_approved') . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>' . $t('email_credito_ambulatorio_autorizacion_cliente.contract_number') . ': </strong>' . $numero_contrato . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>' . $t('email_credito_ambulatorio_aseguradora.holder_name') . ': </strong> ' . $nombre . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>' . $t('email_credito_ambulatorio_aseguradora.patient_name') . ': </strong> ' . $nombre_paciente . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>' . $t('email_credito_ambulatorio_aseguradora.diagnosis') . ': </strong> ' . $diagnostico . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>Tipo de Examen: </strong> ' . $tipo_examen_credito_ambulatorio . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>' . $t('email_credito_ambulatorio_aseguradora.procedure_place') . ': </strong> ' . $lugar_procedimiento_credito_ambulatorio . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>' . $t('email_credito_ambulatorio_aseguradora.procedure_date') . ': </strong> ' . $fecha_procedimiento_credito_ambulatorio . '</h3>
