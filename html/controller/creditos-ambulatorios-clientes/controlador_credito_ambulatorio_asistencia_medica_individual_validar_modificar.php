<?php
    ...
    require 'controlador_credito_ambulatorio_enviar_correo_notificacion_documentos_faltantes_cliente.php';
    require 'controlador_credito_ambulatorio_enviar_correo_aseguradora.php';
    ...
    if ($contar_validar > 0) {
        $MC = new Envio_correo_notificacion_documentos_faltantes_credito_ambulatorio();
        $consulta1 = $MC->realizar_envio_correo_notificacion_documentos_faltantes_credito_ambulatorio($idCreditoAmbulatorio,$idContrato);
    }else {
        $MC1 = new Envio_correo_aseguradora_con_documentos_credito_ambulatorio();
        $consulta2 = $MC1->realizar_envio_correo_aseguradora_con_documentos_credito_ambulatorio($idCreditoAmbulatorio,$idContrato);
    }
