...
class Envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio1
{

    function realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio1($idCreditoAmbulatorio, $idContrato)
    {
        ...
        for ($i = 0; $i < count($consulta); $i++) {
            ...
            $cliente_email_opcional = $consulta[$i]["cliente_email"];
        ...
        try {
            ...
            $mail->addReplyTo('creditoambulatorio@mqpseguros.com', 'Creditos Ambulatorios MQP Seguros');
            $mail->addCC('creditoambulatorio@mqpseguros.com', 'Creditos Ambulatorios MQP Seguros');
