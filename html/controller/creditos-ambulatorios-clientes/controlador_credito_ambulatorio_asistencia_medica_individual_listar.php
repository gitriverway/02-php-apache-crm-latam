        ...
        if (!$consulta) {
            ...
            for ($i = 0; $i < count($consulta); $i++) {
                ...
                foreach ($lista as $value) {
                    ...
                    // $diagnostico .= "<p>" . $value["diagnostico"] . "</p>";
                ...
                if ($consulta[$i]["DOCUMENTO_AUTORIZACION"] != "") {
                    ...
                    if ($consulta[$i]["credito_ambulatorio_estatus"] == "PROCESO") {
                        $btnDocumentoAutorizacion = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnAgregarAutorizacion btn btn-warning' idCreditoAmbulatorio='" . $consulta[$i]["credito_ambulatorio_id"] . "' idBayer='" . $consulta[$i]["bayer_id"] . "' idContrato = '" . $consulta[$i]["contrato_id"] . "' paciente='" . $paciente . "'><i class='fas fa-edit'></i></button></div>";
