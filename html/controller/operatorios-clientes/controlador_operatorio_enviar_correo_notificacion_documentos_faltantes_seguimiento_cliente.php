...
class Envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio
{

    function realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio($idOperatorio, $idContrato)
    {
        global $t;
        ...
        for ($i = 0; $i < count($consulta); $i++) {
            ...
            $operatorio_documentos_seguimiento = json_decode($consulta[$i]["operatorio_documentos_seguimiento"], true);
