...
require 'controlador_operatorio_enviar_correo_autorizacion_cliente.php';
...
$ECL = new Envio_correo_notificacion_autorizacion_operatorio();
$consulta2 = $ECL->realizar_envio_correo_notificacion_autorizacion_operatorio($idOperatorio, $idContrato);
