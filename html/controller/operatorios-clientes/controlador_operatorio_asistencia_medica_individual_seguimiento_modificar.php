<?php
    ...
    require 'controlador_operatorio_enviar_correo_notificacion_documentos_faltantes_seguimiento_cliente.php';
    ...
    if ($estado_caducado == "SI") {
        ...
        if ($enviar_mail == "SI") {
            $CEDFO = new Envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio();
            $consulta1 = $CEDFO->realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio($idOperatorio,$idContrato);
        }
    }
