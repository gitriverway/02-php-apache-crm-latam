        ...
        if (!$consulta) {
            ...
            for ($i = 0; $i < count($consulta); $i++) {
                ...
                if ($consulta[$i]["DOCUMENTO_PEDIDO_ASEGURADORA"] != "") {
                    $btnSeguimiento = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnVerDocumento btn btn-primary' ruta='" . $consulta[$i]["DOCUMENTO_PEDIDO_ASEGURADORA"] . "'><i class='fas fa-file-pdf'></i></button>";
                } else {
                    if ($consulta[$i]["operatorio_estatus"] == "PROCESO") {
                ...
                if ($consulta[$i]["DOCUMENTO_PEDIDO_ASEGURADORA_1"] != "") {
                    $btnSeguimiento1 = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnVerDocumento btn btn-primary' ruta='" . $consulta[$i]["DOCUMENTO_PEDIDO_ASEGURADORA_1"] . "'><i class='fas fa-file-pdf'></i></button>";
                } else {
                    if ($consulta[$i]["operatorio_estatus"] == "PROCESO") {
                ...
                if ($consulta[$i]["DOCUMENTO_AUTORIZACION"] != "") {
                    ...
                    if ($consulta[$i]["operatorio_estatus"] == "PROCESO") {
                        $btnDocumentoAutorizacion = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnAgregarAutorizacion btn btn-warning' idOperatorio='" . $consulta[$i]["operatorio_id"] . "' idBayer='" . $consulta[$i]["bayer_id"] . "' idContrato='" . $consulta[$i]["contrato_id"] . "' paciente = '" . $paciente . "'><i class='fas fa-edit'></i></button></div>";
