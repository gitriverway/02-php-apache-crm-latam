<?php
    ...
    require 'controlador_operatorio_enviar_correo_documentos_seguimiento_aseguradora.php';
    ...
    $MU1 = new Envio_correo_documentos_seguimiento_operatorio();
    $consulta1 = $MU1->realizar_envio_correo_documentos_seguimiento_operatorio($idOperatorio,$idContrato);
