<?php
    ...
    require 'controlador_reembolso_enviar_correo_notificacion_documentos_faltantes_cliente_empresarial.php';
    require 'controlador_reembolso_enviar_correo_aseguradora_empresarial.php';
    ...
    if ($contar_validar > 0) {
        $MC = new Envio_correo_notificacion_documentos_faltantes_reembolso_empresarial();
        $consulta1 = $MC->realizar_envio_correo_notificacion_documentos_faltantes_reembolso_empresarial($idReembolso,$idContrato);
    }else {
        $MC1 = new Envio_correo_aseguradora_con_documentos_reembolso_empresarial();
        $consulta2 = $MC1->realizar_envio_correo_aseguradora_con_documentos_reembolso_empresarial($idReembolso,$idContrato);
    }
