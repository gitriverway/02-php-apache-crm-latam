<?php
    ...
    require 'controlador_reembolso_enviar_correo_notificacion_documentos_faltantes_seguimiento_cliente_empresarial.php';
    ...
    $consulta = $MU->Modificar_Reembolso_Seguimiento($idReembolso,$listaDocumentosSolicitadosAseguradora,$listaObservacionesSeguimientosReembolso,$fecha_seguimiento,$fechaActual,$fechaActual1,$estado_caducado);
    ...
    if ($estado_caducado == "SI") {
        ...
        if ($enviar_mail == "SI") {
            $MC = new Envio_correo_notificacion_documentos_faltantes_seguimiento_reembolso_empresarial();
            $consulta1 = $MC->realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_reembolso_empresarial($idReembolso,$idContrato);
        }
    }
