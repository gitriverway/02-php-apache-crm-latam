...
class Envio_correo_notificacion_documentos_faltantes_seguimiento_reembolso_empresarial_1
{

    function realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_reembolso_empresarial_1($idReembolso, $idContrato)
    {
