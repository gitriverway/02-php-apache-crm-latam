...
class Envio_correo_documentos_seguimiento_reembolso_empresarial_1
{

    function realizar_envio_correo_documentos_seguimiento_reembolso_empresarial_1($idReembolso, $idContrato)
    {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('mireyaquintana@mqpseguros.com', 'Reembolsos RIVERWAYERWAYERWAY Seguros');
            ...
            $mail->Subject = 'REEMBOLSO SEGURO ' . $fechaActual . ' ' . $nombre . ' DOCUMENTOS ADICIONALES';
