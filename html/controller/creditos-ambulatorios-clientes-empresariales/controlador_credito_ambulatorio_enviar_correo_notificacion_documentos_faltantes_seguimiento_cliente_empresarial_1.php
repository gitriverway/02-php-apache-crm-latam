...
function realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio_empresarial_1($idCreditoAmbulatorio, $idContrato)
    {
        ...
        for ($i = 0; $i < count($consulta); $i++) {
            ...
            $credito_ambulatorio_documentos_seguimiento = json_decode($consulta[$i]["credito_ambulatorio_documentos_seguimiento_1"], true);
        ...
        try {
            ...
            <div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
                ...
                <center>
                    <h2 style="font-weight:100; color:#999;">LISTA DOCUMENTOS SOLICITA ASEGURADORA PARA PEDIDO CRÉDITO AMBULATORIO</h2>
                </center>
