...
class Envio_correo_documentos_seguimiento_credito_ambulatorio_empresarial
{

    function realizar_envio_correo_documentos_seguimiento_credito_ambulatorio_empresarial($idCreditoAmbulatorio, $idContrato)
    {
        global $t;
