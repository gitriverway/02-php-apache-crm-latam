...
class Envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio_empresarial
{

    function realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_credito_ambulatorio_empresarial($idCreditoAmbulatorio, $idContrato)
    {
        global $t;
        ...
        $consulta_observaciones = $MU->listar_observacion_creditos_ambulatorios($idCreditoAmbulatorio);

        $nombre = "";
        $correo = "";
        $cliente_email_opcional = "";
        $Ticket = 0;
        $credito_ambulatorio_documentos_seguimiento = "";
        $documento_pedido_aseguradora = "";
        ...
        for ($i = 0; $i < count($consulta); $i++) {
            ...
            $credito_ambulatorio_documentos_seguimiento = json_decode($consulta[$i]["credito_ambulatorio_documentos_seguimiento"], true);
            $documento_pedido_aseguradora = $consulta[$i]["DOCUMENTO_PEDIDO_ASEGURADORA"];
        }

        for ($j = 0; $j < count($consulta_observaciones); $j++) {
            $lista_observaciones = json_decode($consulta_observaciones[$j]["credito_ambulatorio_observacion_descripcion"], true);
        }
        ...
        foreach ($credito_ambulatorio_documentos_seguimiento as $value) {
        ...
        try {
            ...
            $mail->addReplyTo('creditoambulatorio@mqpseguros.com', 'Credito Ambulatorios RIVERWAY Seguros');     //Add a recipient
            $mail->addCC('creditoambulatorio@mqpseguros.com', 'Credito Ambulatorios RIVERWAY Seguros');     //Add a recipient
            ...
            if ($documento_pedido_aseguradora != "") {
                $mail->addAttachment("../../" . $documento_pedido_aseguradora);
            }

            //Content
            $mail->isHTML(true);                                  //Set email format to HTML
            $mail->Subject = $t('email_credito_ambulatorio_documentos_faltantes_seguimiento_cliente.subject', ['ticket' => $Ticket]);
            ...
            <div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
                ...
                <h3 style="font-weight:100; color:#999; padding:0px 20px;">' . $t('email_credito_ambulatorio_documentos_faltantes_seguimiento_cliente.dear_client') . ': ' . $nombre . '</h3>
                <h3 style="font-weight:100; color:#999; padding:0px 20px;">Favor de completar los documentos marcados como
                    <strong>SI</strong>
                </h3>
                <center>
                    <h2 style="font-weight:100; color:#999;">LISTA DOCUMENTOS SOLICITA ASEGURADORA PARA PEDIDO CREDITO AMBULATORIO</h2>
                </center>
                ...
                <h3 style="font-weight:100; color:#999; padding:0px 20px;">Favor enviar los documento en un solo
                    <strong>PDF</strong>, Tiempo limite 72 Horas, al siguiente correo <strong>creditoambulatorio@mqpseguros.com</strong> con numero de Ticket: Número <strong>' . $Ticket . '</strong>
                </h3>
...
<p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('email_credito_ambulatorio_documentos_faltantes_seguimiento_cliente.regards') . ',<o:p>
                                </o:p></span></b></p>
                    <p class=MsoNormal><span style="font-family:Arial,sans-serif">
                            <o:p>&nbsp;</o:p>
                        </span></p>
                    <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('email_credito_ambulatorio_documentos_faltantes_seguimiento_cliente.customer_service_dept') . '<o:p></o:p>
                                </span></b></p>
                    <p class=MsoNormal><span style="font-family:Arial,sans-serif">
                            <o:p>&nbsp;</o:p>
                        </span></p>
...
// =============================================*/
// $envio_correo_empresarial = new Envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio();
// $envio_correo_empresarial -> realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio();