...
class Envio_correo_notificacion_autorizacion_credito_ambulatorio_empresarial
{

function realizar_envio_correo_notificacion_autorizacion_credito_ambulatorio_empresarial($idCreditoAmbulatorio, $idContrato)
    {
        global $t;
...
<h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>' . $t('email_credito_ambulatorio_autorizacion_cliente.contract_number') . ': </strong>' . $numero_contrato . '</h3>
                ...
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>Lugar del Procedimiento: </strong> ' . $lugar_procedimiento_credito_ambulatorio . '</h3>
                <h3 style="font-weight:100; color:#000000; padding:0px 20px;"><strong>Fecha del Procedimiento: </strong> ' . $fecha_procedimiento_credito_ambulatorio . '</h3>
...
<p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('email_credito_ambulatorio_autorizacion_cliente.regards') . ',<o:p>
                                </o:p></span></b></p>
                    <p class=MsoNormal><span style="font-family:Arial,sans-serif">
                            <o:p>&nbsp;</o:p>
                        </span></p>
                    <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('email_credito_ambulatorio_autorizacion_cliente.customer_service_dept') . '<o:p></o:p>
                                </span></b></p>
                    <p class=MsoNormal><span style="font-family:Arial,sans-serif">
                            <o:p>&nbsp;</o:p>
                        </span></p>
