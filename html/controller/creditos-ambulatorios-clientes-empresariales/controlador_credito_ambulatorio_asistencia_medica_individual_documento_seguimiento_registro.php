<?php
    ...
    require 'controlador_credito_ambulatorio_enviar_correo_documentos_seguimiento_aseguradora_empresarial.php';
    ...
    $MU1 = new Envio_correo_documentos_seguimiento_credito_ambulatorio_empresarial();
    $consulta1 = $MU1->realizar_envio_correo_documentos_seguimiento_credito_ambulatorio_empresarial($idCreditoAmbulatorio,$idContrato);
