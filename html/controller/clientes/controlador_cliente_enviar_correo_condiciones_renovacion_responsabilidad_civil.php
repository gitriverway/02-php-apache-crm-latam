...
class Envio_correo_condiciones_renovacion_responsabilidad_civil
{
    ...
    function realizar_envio_correo_condiciones_renovacion_responsabilidad_civil($nombre, $email, $listaCondiciones, $ruta_condiciones, $fecha_fin, $nombre_proveedor)
    {
        ...
        try {
            ...
            $mail->Subject = 'IMPORTANTE: RENOVACIÓN DE RESPONSABILIDAD CIVIL CON ' . $aseguradora . ' - ' . $nombre;
            ...
            $mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
                    ...
                    <div style="position:relative; margin:auto; width:800px; background:white; padding-top:20px; padding-bottom:20px">
                        ...
                        <h4 style="font-weight:100; color:#999; padding:0px 20px; color: #000000; text-align: justify"> Agradecemos la confianza depositada durante este año, ratificamos nuestro compromiso para seguirle acompañando, brindado la tranquilidad y confianza para que usted y su familia estén siempre protegidos. Nos permitimos informarle que está próximo a la renovación de su contrato de responsabilidad civil, para lo cual ponemos a su disposición las condiciones y cambios que aplicarán para su plan actual.
                        </h4>
