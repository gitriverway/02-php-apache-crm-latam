...
class Envio_correo_condiciones_renovacion_responsabilidad_civil
{

    function realizar_envio_correo_condiciones_renovacion_responsabilidad_civil($nombre, $email, $listaCondiciones, $ruta_condiciones, $fecha_fin, $nombre_proveedor)
    {
        global $t;
        ...
        if ($listado_documentos == "") {
            $listado_documentos = '<tr>
                <td style="border: 1px solid #AAAAAA;padding: 3px 2px;font-size: 13px; text-align: center;">' . $t('email_renovacion_responsabilidad_civil.no_records') . '</td>
                </tr>';
        }
        ...
        try {
            ...
            $mail->Subject = $t('email_renovacion_responsabilidad_civil.subject', ['aseguradora' => $aseguradora, 'nombre' => $nombre]);
            ...
            $mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
                    ...
                    <div style="position:relative; margin:auto; width:800px; background:white; padding-top:20px; padding-bottom:20px">
                        ...
                        <h4 style="font-weight:100; color:#999; padding:0px 20px; color: #000000;">' . $t('email_renovacion_responsabilidad_civil.dear_client') . ': ' . $nombre . '</h4>
                        <h4 style="font-weight:100; color:#999; padding:0px 20px; color: #000000; text-align: justify">' . $t('email_renovacion_responsabilidad_civil.renewal_message') . '
                        </h4>
                
                        <h4 style="font-weight:100; color:#999; padding:0px 20px; color: #000000;">' . $t('email_renovacion_responsabilidad_civil.renewal_date') . ': ' . $fecha_fin . '
                        </h4>
                        <center>
                            <table style=" border: 1px solid #1C6EA4;background-color: #EEEEEE;width: 60%;text-align: left;border-collapse: collapse;">
                                <thead style="background: #1C6EA4;background: -moz-linear-gradient(top, #5592bb 0%, #327cad 66%, #1C6EA4 100%);background: -webkit-linear-gradient(top, #5592bb 0%, #327cad 66%, #1C6EA4 100%);background: linear-gradient(to bottom, #5592bb 0%, #327cad 66%, #1C6EA4 100%);border-bottom: 2px solid #444444;">
                                    <th style="font-size: 15px;font-weight: bold;color: #000000;border-left: 2px solid #D0E4F5; border:1px solid #AAAAAA;padding: 3px 2px;">
                                        ' . $t('email_renovacion_responsabilidad_civil.table_header_forma_pago') . '</th>
                                    <th style="font-size: 15px;font-weight: bold;color: #000000;border-left: 2px solid #D0E4F5; border:1px solid #AAAAAA;padding: 3px 2px;">
                                        ' . $t('email_renovacion_responsabilidad_civil.table_header_valor') . '</th>
                                </thead>
                                <tbody>
                                    ' . $listado_documentos . '
                                </tbody>
                        ...
                        <h4 style="font-weight:100; color:#999; padding:0px 20px; color: #000000;">' . $t('email_renovacion_responsabilidad_civil.renewal_value') . '
                        </h4>

                        <p style="color:#000000; padding:15px 20px; font-size:14px; line-height:1.5;">
                            <strong>' . $t('email_renovacion_responsabilidad_civil.note') . '</strong>
                        </p>
                
                        <div class=WordSection1>
                        <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('email_renovacion_responsabilidad_civil.regards') . ',<o:p></o:p>
                                </span></p>
                            <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('email_renovacion_responsabilidad_civil.customer_service_dept') . '<o:p></o:p>
                                    </span></b></p>
                            <p class=MsoNormal><span style="font-family:Arial,sans-serif">
                                    <o:p>&nbsp;</o:p>
                                </span></p>
                            <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">Dirección:</span></b><span style="font-family:Arial,sans-serif"> <span style="color:#2F5496">Centro Empresarial Qworks - Quicentro Shopping, oficina 303<o:p></o:p>
                                    </span></span></p>
