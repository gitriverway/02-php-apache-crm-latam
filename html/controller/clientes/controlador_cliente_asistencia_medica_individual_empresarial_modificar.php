...
require 'controlador_cliente_enviar_correo_condiciones_renovacion_asistencia_medica_empresarial.php';
...
for ($i = 0; $i < count($lista); $i++) {
    ...
    if ($envio_condiciones == 0 && $estado_contrato == "ACTIVO") {
        ...
        if (isset($_FILES["documento_condiciones"])) {
            ...
            $MECCR = new Envio_correo_condiciones_renovacion_asistencia_medica_empresarial();
            $consultaEnvioCondiciones = $MECCR->realizar_envio_correo_condiciones_renovacion_asistencia_medica_empresarial($nombre, $email, $listaCondiciones, $ruta_condiciones, $fecha_fin, $nombre_proveedor);
