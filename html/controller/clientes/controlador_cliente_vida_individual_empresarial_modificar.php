...
for ($i = 0; $i < count($lista); $i++) {
    ...
    $consultaMD = $MD->Modificar_Dependientes($idBayer, $idDependientes, $idContrato, $listaFamiliares, $listaVehiculos, $contra_numero, $fecha_inicio, $fecha_fin, $estado_pago, $fechaActual, $estado_contrato, $envio_condiciones, $ruta_condiciones);
}
