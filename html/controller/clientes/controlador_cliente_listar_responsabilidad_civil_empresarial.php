...
class Lista_asignar_cliente_responsabilidad_civil_empresarial
{

    function mostrar_lista_asignar_responsabilidad_civil_empresarial()
    {
        ...
        switch ($_SESSION['S_ROL']) {
            case 'VENDEDOR':
                $consulta = $MU->listar_cliente_responsabilidad_civil_empresarial_asignados($idUsuario, $idCategoria);
                break;
            default:
                $consulta = $MU->listar_cliente_responsabilidad_civil_empresarial($idCategoria);
                break;
        }
...
=============================================*/
$listaUsuario = new Lista_asignar_cliente_responsabilidad_civil_empresarial();
$listaUsuario->mostrar_lista_asignar_responsabilidad_civil_empresarial();
