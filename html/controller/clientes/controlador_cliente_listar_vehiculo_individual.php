...
class Lista_asignar_cliente
{
    ...
    function mostrar_lista_asignar_cliente()
    {
        ...
        //     $consulta = $MU->listar_cliente_vehiculo_individual($idCategoria);
        // } else {
        //     $consulta = $MU->listar_cliente_vehiculo_individual_asignados($idUsuario,$idCategoria);
        // }
        ...
        if (!$consulta) {
            ...
            for ($i = 0; $i < count($consulta); $i++) {
                ...
                for ($j = 0; $j < count($consulta1); $j++) {
                    ...
                    $vehiculos = $consulta1[$j]["cliente_vehiculos"];
                }
