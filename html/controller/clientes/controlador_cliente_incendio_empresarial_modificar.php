...
require 'controlador_cliente_enviar_correo_condiciones_renovacion_incendio.php';
...
for ($i = 0; $i < count($lista); $i++) {
    ...
    if ($envio_condiciones == 0 && $estado_contrato == "ACTIVO") {
        ...
        if (isset($_FILES["documento_condiciones"])) {
            ...
            $MECCR = new Envio_correo_condiciones_renovacion_incendio();
            $consultaEnvioCondiciones = $MECCR->realizar_envio_correo_condiciones_renovacion_incendio($nombre, $email, $listaCondiciones, $ruta_condiciones, $fecha_fin);
