...
class Envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio_empresarial1
{

    function realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio_empresarial1($idOperatorio, $idContrato)
    {
        global $t;
        ...
        try {
            ...
            <div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
                ...
                <center>
                    <h2 style="font-weight:100; color:#999;">LISTA DOCUMENTOS SOLICITA ASEGURADORA PARA PEDIDO OPERATORIO</h2>
                </center>
