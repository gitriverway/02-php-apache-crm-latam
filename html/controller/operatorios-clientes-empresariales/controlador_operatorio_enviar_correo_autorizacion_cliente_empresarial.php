...
class Envio_correo_notificacion_autorizacion_operatorio_empresarial
{

    function realizar_envio_correo_notificacion_autorizacion_operatorio_empresarial($idOperatorio, $idContrato)
    {
        global $t;
            ...
            <div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
                ...
                <div class=WordSection1>
                    ...
                    <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">Dirección:</span></b><span
                            style="font-family:Arial,sans-serif"> <span style="color:#2F5496">
                                <o:p></o:p></span></span></p>
