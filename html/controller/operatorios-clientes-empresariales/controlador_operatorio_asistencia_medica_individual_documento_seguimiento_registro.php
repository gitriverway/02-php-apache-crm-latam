<?php
    ...
    require 'controlador_operatorio_enviar_correo_documentos_seguimiento_aseguradora_empresarial.php';
    ...
    $MU1 = new Envio_correo_documentos_seguimiento_operatorio_empresarial();
    $consulta1 = $MU1->realizar_envio_correo_documentos_seguimiento_operatorio_empresarial($idOperatorio,$idContrato);
