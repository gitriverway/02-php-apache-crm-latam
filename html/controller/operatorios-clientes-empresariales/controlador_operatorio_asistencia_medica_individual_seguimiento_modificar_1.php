...
require 'controlador_operatorio_enviar_correo_notificacion_documentos_faltantes_seguimiento_cliente_empresarial_1.php';
...
if ($estado_caducado == "SI") {
    ...
    if ($enviar_mail == "SI") {
        $MC = new Envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio_empresarial1();
        $consulta1 = $MC->realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_operatorio_empresarial1($idOperatorio, $idContrato);
    }
}
