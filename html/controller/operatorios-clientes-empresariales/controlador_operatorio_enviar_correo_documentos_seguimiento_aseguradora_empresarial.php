...
class Envio_correo_documentos_seguimiento_operatorio_empresarial
{
    ...
    function realizar_envio_correo_documentos_seguimiento_operatorio_empresarial($idOperatorio, $idContrato)
    {
        ...
        try {
            ...
            <h4 style="font-weight:100; color:#000000; padding:0px 20px;">Número de Contrato: ' . $numero_contrato . '
                ...
                <h4 style="font-weight:100; color:#000000; padding:0px 20px;">Diagnóstico: ' . $lugar_procedimiento . '</h4>
                <h4 style="font-weight:100; color:#000000; padding:0px 20px;">Diagnóstico: ' . $fecha_procedimiento_operatorio . '</h4>
