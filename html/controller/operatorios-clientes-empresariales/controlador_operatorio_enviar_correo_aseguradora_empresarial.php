...
class Envio_correo_aseguradora_con_documentos_operatorio_empresarial
{

    function realizar_envio_correo_aseguradora_con_documentos_operatorio_empresarial($idReembolso, $idContrato)
    {
