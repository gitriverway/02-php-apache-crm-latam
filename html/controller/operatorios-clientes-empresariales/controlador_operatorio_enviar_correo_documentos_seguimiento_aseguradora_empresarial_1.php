...
class Envio_correo_documentos_seguimiento_operatorio_empresarial_1
{

    function realizar_envio_correo_documentos_seguimiento_operatorio_empresarial_1($idOperatorio, $idContrato)
    {
