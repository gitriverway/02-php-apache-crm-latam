...
class Envio_correo_notificacion_documentos_faltantes_operatorio_empresarial
{
    ...
    function realizar_envio_correo_notificacion_documentos_faltantes_operatorio_empresarial($idOperatorio, $idContrato)
    {
        ...
        try {
            ...
            $mail->Subject = 'IMPORTANTE: DOCUMENTOS FALTANTES EN CRÉDITO HOSPITALARIO Nº ' . $Ticket . ' - ASISTENCIA MÉDICA';
