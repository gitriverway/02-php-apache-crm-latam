    ...
    function mostrar_lista_contrato_cliente()
    {
        ...
        if (!$consulta) {
            ...
            for ($i = 0; $i < count($consulta); $i++) {
                ...
                if ($consulta[$i]["RUC"] != "") {
                    $btnRuc = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnVerDocumento btn btn-primary' ruta='" . $consulta[$i]["RUC"] . "'><i class='fas fa-file-pdf'></i></button></div>";
                } else {
                    $btnRuc = "";
                }
                ...
                if ($consulta[$i]["LISTA PERSONAL"] != "") {
                    $btnListaPersonal = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnVerDocumento btn btn-primary' ruta='" . $consulta[$i]["LISTA PERSONAL"] . "'><i class='fas fa-file-pdf'></i></button></div>";
                } else {
                    $btnListaPersonal = "";
                }
