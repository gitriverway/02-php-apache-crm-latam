            ...
            if(!$consulta){
                ...
                $datosJson = '{
                    ...
                    for($i = 0; $i < count($consulta); $i++){
                            ...
                            $botones =  "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnSeleccionarContrato btn btn-primary' idCliente='" . $consulta[$i]["bayer_id"] . "' numeroContrato = '".$consulta[$i]["contrato_numero"]."'><i class='fa fa-eye'></i></button></div>";
