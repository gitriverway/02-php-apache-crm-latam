    ...
    function mostrar_lista_contrato_cliente()
    {
        ...
        if (!$consulta) {
            ...
            for ($i = 0; $i < count($consulta); $i++) {
                ...
                if ($consulta[$i]["FORMULARIO VINCULACION"] != "") {
                    $btnSolicitudAfiliacion = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnVerDocumento btn btn-primary' ruta='" . $consulta[$i]["FORMULARIO VINCULACION"] . "'><i class='fas fa-file-pdf'></i></button></div>";
                } else {
                ...
                if ($consulta[$i]["ENDOSOS"] != "") {
                    $btnEndosos = "<div class='btn-group'><button style='font-size:13px;' type='button' class='btnVerDocumento btn btn-primary' ruta='" . $consulta[$i]["ENDOSOS"] . "'><i class='fas fa-file-pdf'></i></button></div>";
                } else {
                    $btnEndosos = "";
                }
