...
require 'controlador_credito_ambulatorio_enviar_correo_notificacion_observaciones.php';
...
$MO = new Envio_correo_notificacion_observaciones_credito_ambulatorio();
$consulta1 = $MO->realizar_envio_correo_notificacion_observaciones_credito_ambulatorio($idCreditoAmbulatorio, $idContrato);
