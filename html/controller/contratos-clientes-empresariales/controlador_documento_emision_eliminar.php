<?php
    ...
    $carpeta_documento = "../../view/contratos-pymes/".$_POST['idCliente']."/".$_POST['carpetaDocumento'];
    $contador_documento_carpeta = scandir("../../view/contratos-pymes/".$_POST['idCliente']."/".$_POST['carpetaDocumento']);
