<?php
    ...
    require 'controlador_reembolso_enviar_correo_notificacion_documentos_faltantes_seguimiento_cliente_1.php';
    ...
    if ($estado_caducado == "SI") {
        ...
        if ($enviar_mail == "SI") {
            $MC = new Envio_correo_notificacion_documentos_faltantes_seguimiento_reembolso_1();
            $consulta1 = $MC->realizar_envio_correo_notificacion_documentos_faltantes_seguimiento_reembolso_1($idReembolso,$idContrato);
        }
    }
