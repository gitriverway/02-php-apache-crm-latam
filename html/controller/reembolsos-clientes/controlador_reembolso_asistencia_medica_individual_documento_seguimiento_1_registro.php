<?php
    ...
    require 'controlador_reembolso_enviar_correo_documentos_seguimiento_aseguradora_1.php';
    ...
    $MU1 = new Envio_correo_documentos_seguimiento_reembolso_1();
    $consulta1 = $MU1->realizar_envio_correo_documentos_seguimiento_reembolso_1($idReembolso,$idContrato);
