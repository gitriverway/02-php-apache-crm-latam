<?php
    ...
    require 'controlador_reembolso_enviar_correo_documentos_seguimiento_aseguradora.php';
    ...
    $MU1 = new Envio_correo_documentos_seguimiento_reembolso();
    $consulta1 = $MU1->realizar_envio_correo_documentos_seguimiento_reembolso($idReembolso,$idContrato);
