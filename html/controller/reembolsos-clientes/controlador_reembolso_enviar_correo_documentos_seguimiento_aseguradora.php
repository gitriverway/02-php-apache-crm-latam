...
class Envio_correo_documentos_seguimiento_reembolso
{
    ...
    function realizar_envio_correo_documentos_seguimiento_reembolso($idReembolso, $idContrato)
    {
        ...
        try {
            ...
            $mail->Subject = $t('emails.reembolso_seguimiento_aseguradora.subject', ['fecha' => $fechaActual, 'nombre' => $nombre]);
            ...
            <h3 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('emails.reembolso_seguimiento_aseguradora.dear_colleagues') . '</h3>
            <h3 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('emails.reembolso_seguimiento_aseguradora.attached_documents') . '</h3>
    
            <h4 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('emails.reembolso_seguimiento_aseguradora.contract_number') . ': ' . $numero_contrato . '
                </h4>
                <h4 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('emails.reembolso_seguimiento_aseguradora.holder_name') . ': ' . $nombre . '
                </h4>
                <h4 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('emails.reembolso_seguimiento_aseguradora.patient_name') . ': ' . $nombre_paciente . '</h4>
                <h4 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('emails.reembolso_seguimiento_aseguradora.diagnosis') . ': ' . $diagnostico . '</h4>
    
                <h4 style="font-weight:100; color:#000000; padding:0px 20px;">' . $t('emails.reembolso_seguimiento_aseguradora.presented_value') . ': $' . $valor_presentado . '</h4>

                <p style="color:#000000; padding:15px 20px; font-size:14px; line-height:1.5;">
                    <strong>' . $t('emails.reembolso_seguimiento_aseguradora.note') . '</strong>
                </p>
        
                <div class=WordSection1>
                    <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('emails.reembolso_seguimiento_aseguradora.regards') . ',<o:p>
                                </o:p></span></b></p>
                    <p class=MsoNormal><span style="font-family:Arial,sans-serif">
                            <o:p>&nbsp;</o:p>
                        </span></p>
                    <p class=MsoNormal><b><span style="font-family:Arial,sans-serif;color:#1F3864">' . $t('emails.reembolso_seguimiento_aseguradora.department') . '<o:p></o:p>
                                </span></b></p>
                    <p class=MsoNormal><span style="font-family:Arial,sans-serif">
                            <o:p>&nbsp;</o:p>
                        </span></p>
