...
$idBayer = htmlspecialchars($_POST['idProspecto'], ENT_QUOTES, 'UTF-8');
$idDependiente = htmlspecialchars($_POST['idDependiente'], ENT_QUOTES, 'UTF-8');
