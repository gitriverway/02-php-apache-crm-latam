...
class Envio_correo_notificacion_observaciones_credito_ambulatorio_empresarial
{

    function realizar_envio_correo_notificacion_observaciones_credito_ambulatorio_empresarial($idCreditoAmbulatorio, $idContrato)
    {
