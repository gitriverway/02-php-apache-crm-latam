...
if ($estado_bayer == "CONTRATADO") {
    ...
    switch ($categoria) {
        case '3':
            $ACE = new Envio_correo_notificacion_nuevo_contrato_asistencia_medica();
            $consulta2 = $ACE->realizar_envio_correo_notificacion_nuevo_contrato_asistencia_medica($idBayer);
            break;
