...
class Envio_correo_notificacion_nuevo_contrato_asistencia_medica
{

    function realizar_envio_correo_notificacion_nuevo_contrato_asistencia_medica($idBayer)
    {
        ...
        try {
            ...
            $mail->Subject = 'NOTIFICACIÓN DE NUEVO CONTRATO - ASISTENCIA MÉDICA';
...
// =============================================*/
// $envio_correo_empresarial = new Envio_correo_notificacion_nuevo_contrato_asistencia_medica();
// $envio_correo_empresarial -> realizar_envio_correo_notificacion_nuevo_contrato_asistencia_medica();