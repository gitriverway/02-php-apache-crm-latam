                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="cbm_proveedor" class="control-label"
                                        style="text-align: right;"><?php echo $t('edit_forms.insurance_plan'); ?>
                                        <font color="red"> *</font>
                                    </label>
                                    <div class="input-group">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="txt_prima_neta" class="control-label"
                                        style="text-align: right;"><?php echo $t('edit_forms.net_premium'); ?>
                                    </label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">$</span>
                            ...
                            <div class="col-sm-12  col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="txt_prima_total" class="control-label"
                                        style="text-align: right;"><?php echo $t('edit_forms.total_premium'); ?><font
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="cbm_tipo_pago" class="control-label"
                                        style="text-align: right;"><?php echo $t('edit_forms.payment_frequency'); ?>
                                        <font color="red"> *</font>
                                    </label>
                                    <select class="form-control cbm_tipo_pago" name="state" id="cbm_tipo_pago"
                                        style="width:100%;">
                                        <option value=""><?php echo $t('messages.select_option'); ?></option>
                                        <option value="MENSUAL"><?php echo $t('forms.monthly'); ?></option>
                                        <option value="TRIMESTRAL"><?php echo $t('forms.quarterly'); ?></option>
                                        <option value="SEMESTRAL"><?php echo $t('forms.semi_annual'); ?></option>
                                        <option value="ANUAL"><?php echo $t('forms.annual'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control cbm_forma_pago" name="state" id="cbm_forma_pago"
                                        ...
                                        <option value="TARJETA DE CREDITO"><?php echo $t('forms.credit_card'); ?>
                                        </option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                ...
                                <div class="form-group">
                                    <label for="txt_documento" class="control-label"
                                        style="text-align: right;"><?php echo $t('edit_forms.id_card'); ?>
                                        <font color="red"> *</font>
                                    </label>
                                    <div class="input-group">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group">
                                    <label for="txt_nombre" class="control-label"
                                        style="text-align: right;"><?php echo $t('edit_forms.name'); ?>
                                        <font color="red"> *</font>
                                    </label>
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label"
                                        style="text-align: right;"><?php echo $t('edit_forms.gender'); ?>
                                        <font color="red"> *</font>
                                    </label>
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control validarNumerosLetras"
                                        id="txt_telefono_opcional" placeholder="<?php echo $t('forms.enter_phone'); ?>"
                                        maxlength="50" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6 d-none">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="txt_ciudad" class="control-label" style="text-align: right;"><?php echo $t('list_tables.country'); ?>
                                        <font color="red"> *</font>
                                    </label>
                                        ...
                                        <div class="form-group row" id="grupo_file">
                                            ...
                                            <div class="form-group col-12 col-md-4  d-none">
                                                <label for="txt_documento_8" class="control-label"
                                                    style="text-align: right;"><?php echo $t('form.current_debit'); ?><font color="red">
                                                        *</font>
                                                </label>
                                            ...
                                            <div class="form-group col-12 col-md-4  d-none">
                                                <label for="txt_documento_12" class="control-label"
                                                    style="text-align: right;"><?php echo $t('form.form_payment_change'); ?><font
                                                        color="red"> *</font>
                                                </label>
                                            ...
                                            <div class="form-group col-12 col-md-4  d-none">
                                                <label for="txt_documento_10" class="control-label"
                                                    style="text-align: right;"><?php echo $t('form.refund_reach'); ?><font color="red"> *
                                                    </font>
                                                </label>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control cbm_estado_bayer" name="state"
                                                ...
                                                <option value="NO INTERESADO"><?php echo $t('status.not_interested'); ?>
                                                </option>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center; width:10px">
                                        <?php echo $t('document_names.id_card'); ?>/RUC</th>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="txt_observacion" class="control-label"
                            style="text-align: right;"><?php echo $t('forms.observation'); ?>
                            <font color="red"> *</font>
                        </label>
                    ...
                    <table id="tabla_lista_contratos" class="table table-bordered table-striped dt-responsive"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center; width:10px"><?php echo $t('table.registration_date'); ?>
                                </th>
