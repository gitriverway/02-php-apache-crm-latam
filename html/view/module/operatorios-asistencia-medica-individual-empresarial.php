...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Crédito Hopitalario Asistencia Medica Individual Pymes
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio"><?php echo $t('common.home'); ?></a></li>
                        <li class="breadcrumb-item active">Crédito Hopitalario Asistencia Medica Individual Pymes</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <table id="tabla-listar-operatorios-asistencia-medica-individual"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; width:10px">Número Solicitud Operatorio</th>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="date" class="form-control fecha_seguimiento1" id="txt_fecha_seguimiento1"
...
<!--=====================================
MODAL AGREGAR DOCUMENTOS SEGUIMIENTO OPERATORIO 1
======================================-->
        ...
        <div class="modal-content" id="modalDocumentoSeguimientoOperatorio1">
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                        onclick="Registrar_Documento_Seguimiento_Operatorio_1()"><i
                            class="fa fa-save"><b>&nbsp;REGISTRAR</b></i></button>
                </div>
            </form>
        </div>
...
<script type="text/javascript" src="/js/operatorios-asistencia-medica-individual-empresarial.js?rev=<?php echo time(); ?>"></script>
<script>
