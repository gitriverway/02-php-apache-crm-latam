    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo $t('form.observations'); ?> - <span id="observacionesPaciente"></span></h4>
        ...
        <div class="modal-content" id="modalValidarDocumentosReembolso">
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title"><?php echo $t('form.validate_refund_documents'); ?> - <span id="validarNombrePaciente"></span></h5>
                </div>
                <div class="modal-body">
                    <div class="row validarDatosReembolso">
                        ...
                        <div class="form-group col-12 col-lg-4 col-md-6">
                            <label for="radio_pedido_examenes" class="control-label"><?php echo $t('form.exam_requests'); ?><font
                                    color="red"> *</font>
                            </label>
                            <div class="form-check">
                        ...
                        <div class="form-group col-12 col-lg-4 col-md-6">
                            <label for="radio_resultado_examenes" class="control-label"><?php echo $t('form.exam_results'); ?><font
                                    color="red"> *</font>
                            </label>
                            <div class="form-check">
                        ...
                        <div class="form-group col-12 col-lg-4 col-md-6">
                            <label for="radio_protocolo_operatorio" class="control-label"><?php echo $t('form.surgical_protocol'); ?><font
                                    color="red"> *</font>
                            </label>
                            <div class="form-check">
...
<script type="text/javascript" src="/js/reembolsos-asistencia-medica-individual.js?rev=<?php echo time(); ?>"></script>
<script>
