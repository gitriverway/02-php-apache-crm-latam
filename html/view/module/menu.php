...
<aside class="main-sidebar sidebar-light-info elevation-4">
    ...
    <a href="inicio" class="brand-link">
        <img src="view/dist/img/riverway.jpg" alt="<?php echo $t('common.adminlte_logo'); ?>"
            class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light"><strong><?php echo $t('form.riverway'); ?></strong></span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img id="img_lateral" src="view/dist/img/avatar5.png" class="img-circle elevation-2"
