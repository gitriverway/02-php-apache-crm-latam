...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Contratos Clientes Vehiculos
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
                        <li class="breadcrumb-item active">Administrar Contratos - Clientes Vehiculos</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <table id="tabla-contrato-cliente" class="table table-bordered table-striped" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; width:10px">Endosos</th>
