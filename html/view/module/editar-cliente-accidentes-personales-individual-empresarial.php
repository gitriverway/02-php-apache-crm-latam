...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1>Editar Emisi&oacute;n Accidentes Personales Pymes
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio"><?php echo $t('common.home'); ?></a></li>
                        <li class="breadcrumb-item active">Editar Emisi&oacute;n Accidentes Personales Pymes</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script type="text/javascript" src="/js/clientes-accidentes-personales-individual-empresarial.js?rev=<?php echo time(); ?>"></script>
<script>
