...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo $t('common.report_claims_transporte_pymes'); ?>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio"><?php echo $t('common.home'); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo $t('common.report_claims_transporte_pymes'); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="tabla-listar-siniestros-transporte-empresarial" class="table table-bordered table-striped"
                    style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; width:10px"><?php echo $t('form.claim_detail'); ?></th>
                            ...
                            <th style="text-align:center; width:10px"><?php echo $t('form.adjustment_acceptance_authorization'); ?></th>
                            ...
                            <th style="text-align:center; width:10px"><?php echo $t('form.claim_value'); ?></th>
                            ...
                            <th style="text-align:center; width:10px"><?php echo $t('form.indemnify_value'); ?></th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo $t('form.claim_detail'); ?> - <span id="modalDetalleSiniestroTransporte"></span>
                </h4>
...
<div class="modal fade" id="modalObservaciones">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Observaciones - <span id="modalObservacionesSiniestroTransporte"></span></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">VALIDAR <?php echo $t('form.documents'); ?> SINIESTRO - <span
                            id="modalModificarSiniestroTransporte"></span>
                    </h5>
                </div>
                <div class="modal-body">
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">AGREGAR OBSERVACIONES AL SINIESTRO - <span
                            id="modalAgregarObservacionesAdicionalesSiniestroTransporte"></span></h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-12">
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">AGREGAR AJUSTE AL SINIESTRO - <span
                            id="modalAgregarAjusteAutorizacionSiniestroTransporte"></span></h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-12">
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">AGREGAR SEGUIMIENTO AL SINIESTRO - <span
                            id="modalAgregarSeguimientoSiniestroTransporte"></span></h5>
                </div>
                <div class="modal-body">
                    <!--=====================================
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">AGREGAR DOCUMENTO ADICIONALES AL SINIESTRO - <span
                            id="modalAgregarDocumentoSeguimientoSiniestroTransporte"></span></h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-12">
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">AGREGAR DOCUMENTO LIQUIDACION AL SINIESTRO - <span
                            id="modalAgregarDocumentoLiquidacionSiniestroTransporte"></span></h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            <label for="txt_paciente_siniestro" class="control-label"
                                style="text-align: right;">TRANSPORTE SINIESTRADO
                                <font color="red"> *</font>
                            </label>
...
<div id="modalAgregarObservacionAnulacionSiniestro" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">AGREGAR ANULACIÓN AL SINIESTRO TRANSPORTE - <span
                            id="modalAgregarObservacionAnulacionSiniestroTransporte"></span></h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-12">
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row nuevoDatosSiniestro">
                        ...
                        <div class="form-group col-12">
                            <label for="cbm_transporte" class="control-label" style="text-align: right;">TRANSPORTE
                                <font color="red"> *</font>
                            </label>
