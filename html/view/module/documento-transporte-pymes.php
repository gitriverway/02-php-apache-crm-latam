...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo $t('common.forms_transporte_pymes'); ?>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio"><?php echo $t('common.home'); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo $t('common.forms_transporte_pymes'); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <table id="tabla-contrato-documento-cliente" class="table table-bordered table-striped"
                    style="width:100%">
                    <thead>
                        <tr>
...
<script type="text/javascript" src="/js/documento-transporte-pymes.js?rev=<?php echo time(); ?>"></script>
<script>
