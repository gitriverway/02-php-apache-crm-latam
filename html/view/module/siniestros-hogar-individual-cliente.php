...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="tabla-listar-siniestros-hogar-individual" class="table table-bordered table-striped nowrap"
                    style="width:100%">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo $t('form.observations'); ?></h4>
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row nuevoDatosSiniestro">
                        ...
                        <div class="form-group col-12 col-lg-4">
                            <label for="cbm_hogar" class="control-label" style="text-align: right;">HOGAR
                                <font color="red"> *</font>
                            </label>
                            <select class="form-control cbm_hogar js-example-basic-single" name="state" id="cbm_hogar"
                                style="width:100%;">
