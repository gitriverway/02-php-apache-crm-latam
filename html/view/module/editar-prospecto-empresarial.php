                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="txt_documento" class="control-label" style="text-align: right;">RUC
                                        <font color="red"> *</font>
                                    </label>
                                    <div class="input-group">
                            ...
                            <div class="col-sm-12">
                                <!-- ENTRADA PARA NOMBRE -->
                                <div class="form-group">
                                    <label for="txt_nombre" class="control-label" style="text-align: right;">RAZÓN
                                        SOCIAL
                                        <font color="red"> *</font>
                                    </label>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="txt_ocupacion" class="control-label"
                                        style="text-align: right;">ACTIVIDAD ECONÓMICA<font color="red"> *</font>
                                    </label>
                            ...
                            <div class="col-sm-12 d-none">
                                ...
                                <div class="form-group">
                                    <label for="cbm_ingreso_mensual" class="control-label"
                                        style="text-align: right;"><?php echo $t('form.income'); ?><font color="red"> *</font>
                                    </label>
        ...
        <div class="modal-content">
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $t('form.cancel'); ?></button>
