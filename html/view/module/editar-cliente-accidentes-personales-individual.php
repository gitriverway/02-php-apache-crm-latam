            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><?php echo $t('messages.edit_emission_accidents_individual'); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="txt_valor_asegurado" placeholder="<?php echo $t('forms.enter_insured_amount'); ?>" min="0"
...
<script type="text/javascript" src="/js/clientes-accidentes-personales-individual.js?rev=<?php echo time(); ?>"></script>
<script>
