...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo $t('common.report_claims_vehiculo'); ?>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio"><?php echo $t('common.home'); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo $t('common.claims_vehiculo_individual'); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <table id="tabla-listar-siniestros-vehiculo-individual"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; width:10px"><?php echo $t('form.vehicle'); ?></th>
                            ...
                            <th style="text-align:center; width:10px"><?php echo $t('form.adjustment_acceptance_authorization'); ?> - <?php echo $t('form.adjustment_third_party'); ?>
                            </th>
                            <th style="text-align:center; width:10px"><?php echo $t('form.required_document'); ?></th>
...
<script type="text/javascript" src="/js/siniestros-vehiculo-individual-cliente.js?rev=<?php echo time(); ?>"></script>
<script>
