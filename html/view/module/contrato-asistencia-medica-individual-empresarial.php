...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Contratos Asistencia Medica Individual Pymes
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
                        <li class="breadcrumb-item active">Administrar Contratos Asistencia Medica Individual Pymes</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script src="js/contrato-asistencia-medica-individual-empresarial.js?rev=<?php echo time();?>"></script>
<script>
