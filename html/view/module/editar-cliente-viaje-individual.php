...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1><?php echo $t('edit_forms.edit_vehicle_individual'); ?>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio"><?php echo $t('common.home'); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo $t('edit_forms.edit_vehicle_individual'); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                        ...
                                        <div class="form-group row" id="grupo_file">
                                            <div class="form-group col-12 col-md-4">
                                                <label for="txt_documento_1" class="control-label"
                                                    style="text-align: right;"><?php echo $t('common.id_card'); ?><font color="red"> *</font>
                                                </label>
                                            ...
                                            <div class="form-group col-12 col-md-4">
                                                <label for="txt_documento_6" class="control-label"
                                                    style="text-align: right;" <?php echo $t("form.endorsement"); ?>font color="red">
                                                    *</font>
                                                </label>
                                            ...
                                            <div class="form-group col-12 col-md-4">
                                                <label for="txt_documento_7" class="control-label"
                                                    style="text-align: right;" <?php echo $t("form.claim_report"); ?>font color="red">
                                                    *</font>
                                                </label>
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary" id="cardSeguimiento">
                    ...
                    <div class="card-footer">
                        <div class="row pb-3">
                            <div class="col-12">
                                <a href="clientes-vehiculo-individual"><button type="button" class="btn btn-default"
