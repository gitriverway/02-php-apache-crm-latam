                ...
                <table id="tabla-listar-siniestros-hogar-individual" class="table table-bordered table-striped"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; width:10px"<?php echo $t('form.third_party_damages'); ?></th>
        ...
        <div class="modal-content" id="modalValidarDocumentosSiniestro">
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    <h5 class="modal-title">REVISAR <?php echo $t('form.documents'); ?> SINIESTRO - <span
                ...
                <div class="modal-body">
                    ...
                    <div class="row validarDatosSiniestro">
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"><?php echo $t('form.third_party_documents'); ?></h3>
                                </div>
                                <div class="card-body">
                                    <div class=" row">
                                        <div class="form-group col-12 col-lg-3 col-md-4">
