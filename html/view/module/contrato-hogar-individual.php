...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo $t("common.manage_hogar_contracts"); ?>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio"><?php echo $t("common.home"); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo $t("common.manage_hogar_contracts"); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <table id="tabla-contrato-cliente" class="table table-bordered table-striped" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; width:10px">
                                <?php echo $t("list_tables.individual_menage_forms"); ?></th>
...
<script type="text/javascript" src="/js/contrato-hogar-individual.js?rev=<?php echo time(); ?>"></script>
<script>
