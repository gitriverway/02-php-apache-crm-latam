...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1><?php echo $t('common.edit_emission_vida_collective_pymes'); ?>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <?php echo $t('common.edit_emission_vida_collective_pymes'); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card card-primary" id="cardBayer">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="txt_valor_asegurado" class="control-label" style="text-align: right;">VALOR
                                    ASEGURADO
                                    <font color="red"> *</font>
                                </label>
                                <div class="input-group">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        class="form-control validarNumerosDecimal input-lg valores_emision"
                                        id="txt_prima_neta" placeholder="<?php echo $t('forms.enter_net_premium'); ?>"
                                        min="0" maxlength="30" autocomplete="off">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        class="form-control validarNumerosDecimal input-lg valores_emision"
                                        id="txt_prima_comisionable"
                                        placeholder="<?php echo $t('forms.enter_commissionable_premium'); ?>" min="0"
                                        maxlength="30" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- <div class="input-group-append">
                                            <button type="submit" class="btn btn-primary btnListarClientes"><i class="fas fa-search"></i></button>
                                        </div> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control validarNumerosLetras" id="txt_telefono_opcional"
                                    placeholder="<?php echo $t('forms.enter_phone'); ?>" maxlength="50"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 d-none">
                            ...
                            <div class="form-group">
                                <label for="cbm_provincia" class="control-label"
                                    style="text-align: right;"><?php echo $t('common.province'); ?><font color="red"> *
                                    </font></label>
                                    ...
                                    <div class="form-group row" id="grupo_file">
                                        ...
                                        <div class="form-group col-12 col-md-4 d-none">
                                            <label for="txt_documento_4" class="control-label"
                                                style="text-align: right;"><?php echo $t('common.affiliation_request'); ?>
                                                <font color="red"> *
                                                </font>
                                            </label>
                                        ...
                                        <div class="form-group col-12 col-md-4">
                                            <label for="txt_documento_5" class="control-label"
                                                style="text-align: right;"><?php echo $t('common.nomination_letter'); ?>
                                                <font color="red">
                                                    *</font>
                                            </label>
                                        ...
                                        <div class="form-group col-12 col-md-4 d-none">
                                            <label for="txt_documento_8" class="control-label"
                                                style="text-align: right;"><?php echo $t('common.current_bank_debit'); ?>
                                                <font color="red">
                                                    *</font>
                                            </label>
                                        ...
                                        <div class="form-group col-12 col-md-4 d-none">
                                            <label for="txt_documento_12" class="control-label"
                                                style="text-align: right;"><?php echo $t('common.payment_change_form'); ?>
                                                <font color="red"> *</font>
                                            </label>
                                        ...
                                        <div class="form-group col-12 col-md-4 d-none">
                                            <label for="txt_documento_9" class="control-label"
                                                style="text-align: right;"><?php echo $t('common.bmi_gift'); ?><font
                                                    color="red"> *
                                                </font>
                                            </label>
                                        ...
                                        <div class="form-group col-12 col-md-4 d-none">
                                            <label for="txt_documento_10" class="control-label"
                                                style="text-align: right;"><?php echo $t('common.reimbursement_coverage'); ?>
                                                <font color="red"> *
                                                </font>
                                            </label>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary" id="cardSeguimiento">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label for="cbm_estado_bayer" class="control-label"
                                            style="text-align: right;"><?php echo $t('common.status_label'); ?><font
                                                color="red"> *</font>
                                        </label>
                                        <select class="form-control cbm_estado_bayer" name="state" id="cbm_estado_bayer"
                                            style="width:100%;">
                                            <option value=""><?php echo $t('messages.select_option'); ?></option>
                                            <option value="ABIERTO"><?php echo $t('status.open'); ?></option>
                                            <option value="NO INTERESADO"><?php echo $t('common.not_interested'); ?>
                                            </option>
                ...
                <div class="card-footer">
                    <div class="row pb-3">
                        <div class="col-12">
                            <a href="clientes-vida-individual-empresarial"><button type="button" class="btn btn-default"
                                    data-dismiss="modal"><?php echo $t('buttons.cancel'); ?></button></a>
                            <button type="submit" class="btn btn-primary float-right" onclick="Modificar_Cliente()"><i
            ...
            <form autocomplete="false" onsubmit="return false" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                        data-dismiss="modal"><?php echo $t('buttons.cancel'); ?></button>
                    <button type="button"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="txt_observacion" class="control-label"
                            style="text-align: right;"><?php echo $t('form.observation'); ?>
                            <font color="red"> *</font>
                        </label>
...
<script type="text/javascript" src="/js/clientes-vida-individual-empresarial.js?rev=<?php echo time(); ?>"></script>
<script>
