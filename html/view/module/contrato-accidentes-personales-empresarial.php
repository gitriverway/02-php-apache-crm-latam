...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo $t("common.manage_personal_accident_contracts_pymes"); ?>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <?php echo $t("common.manage_personal_accident_contracts_pymes"); ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; width:10px">
                                <?php echo $t("list_tables.contract_number"); ?></th>
                            ...
                            <th style="text-align:center; width:10px"><?php echo $t("list_tables.personal_list"); ?>
                            </th>
...
<script type="text/javascript" src="/js/contrato-accidentes-personales-empresarial.js?rev=<?php echo time(); ?>"></script>
<script>
