...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-fixed login-page">
  ...
  <script type="text/javascript" src="/js/idioma.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/plantilla.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/utils.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/prospectos.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/clientes.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/renovaciones.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/reembolsos.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/creditos.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/siniestros.js?rev=<?php echo time(); ?>"></script>
  <script type="text/javascript" src="/js/notificaciones/main.js?rev=<?php echo time(); ?>"></script>
  <script>
